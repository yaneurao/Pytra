...
function palette_332()
    ...
    local __hoisted_cast_1 = __pytra_float(7)
    local __hoisted_cast_2 = __pytra_float(3)
    for i = 0, 256 - 1 do
        r = ((i + 5) + 7)
        g = ((i + 2) + 7)
        b = (i + 3)
        p[(((((i * 3) + 0)) < 0) and (#(p) + (((i * 3) + 0)) + 1) or ((((i * 3) + 0)) + 1))] = __pytra_int(((255 * r) / __hoisted_cast_1))
        p[(((((i * 3) + 1)) < 0) and (#(p) + (((i * 3) + 1)) + 1) or ((((i * 3) + 1)) + 1))] = __pytra_int(((255 * g) / __hoisted_cast_1))
        p[(((((i * 3) + 2)) < 0) and (#(p) + (((i * 3) + 2)) + 1) or ((((i * 3) + 2)) + 1))] = __pytra_int(((255 * b) / __hoisted_cast_2))
    end
...
function render_frame(width, height, frame_id, frames_n)
    ...
    aspect = (width / height)
    fov = 1.25
    local __hoisted_cast_3 = __pytra_float(height)
    local __hoisted_cast_4 = __pytra_float(width)
