...
func scene(x float64, y float64, light_x float64, light_y float64) int64 {
    ...
    var r1 any = math.Sqrt(__pytra_float((__pytra_float((__pytra_float(x1) * __pytra_float(x1))) + __pytra_float((__pytra_float(y1) * __pytra_float(y1))))))
    var r2 any = math.Sqrt(__pytra_float((__pytra_float((__pytra_float(x2) * __pytra_float(x2))) + __pytra_float((__pytra_float(y2) * __pytra_float(y2))))))
    var blob any = (math.Exp(__pytra_float((((-float64(7.0)) * r1) * r1))) + math.Exp(__pytra_float((((-float64(8.0)) * r2) * r2))))
    ...
    var l any = math.Sqrt(__pytra_float((__pytra_float((__pytra_float(lx) * __pytra_float(lx))) + __pytra_float((__pytra_float(ly) * __pytra_float(ly))))))
...
func run_14_raymarching_light_cycle() {
    ...
    for t := __pytra_int(int64(0)); (__step_0 >= 0 && t < __pytra_int(frames_n)) || (__step_0 < 0 && t > __pytra_int(frames_n)); t += __step_0 {
        ...
        var a float64 = __pytra_float((((__pytra_float(t) / __pytra_float(frames_n)) * math.Pi) * float64(2.0)))
        ...
        for y := __pytra_int(int64(0)); (__step_1 >= 0 && y < __pytra_int(h)) || (__step_1 < 0 && y > __pytra_int(h)); y += __step_1 {
            ...
            var py float64 = __pytra_float((__pytra_float((__pytra_float((__pytra_float(y) / __pytra_float((__pytra_int(h) - __pytra_int(int64(1)))))) * __pytra_float(float64(2.0)))) - __pytra_float(float64(1.0))))
            __step_2 := __pytra_int(int64(1))
            for x := __pytra_int(int64(0)); (__step_2 >= 0 && x < __pytra_int(w)) || (__step_2 < 0 && x > __pytra_int(w)); x += __step_2 {
                var px float64 = __pytra_float((__pytra_float((__pytra_float((__pytra_float(x) / __pytra_float((__pytra_int(w) - __pytra_int(int64(1)))))) * __pytra_float(float64(2.0)))) - __pytra_float(float64(1.0))))
