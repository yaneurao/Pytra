...
fun palette(): MutableList<Any?> {
    ...
    while ((__step_0 >= 0L && i < __pytra_int(256L)) || (__step_0 < 0L && i > __pytra_int(256L))) {
        ...
        var b: Long = __pytra_int(__pytra_min(255L, __pytra_int((__pytra_int(30L) + __pytra_int(i)))))
...
fun scene(x: Double, y: Double, light_x: Double, light_y: Double): Long {
    ...
    var r1: Any? = kotlin.math.sqrt(__pytra_float((__pytra_float((__pytra_float(x1) * __pytra_float(x1))) + __pytra_float((__pytra_float(y1) * __pytra_float(y1))))))
    var r2: Any? = kotlin.math.sqrt(__pytra_float((__pytra_float((__pytra_float(x2) * __pytra_float(x2))) + __pytra_float((__pytra_float(y2) * __pytra_float(y2))))))
    var blob: Any? = (kotlin.math.exp(__pytra_float((((-7.0) * r1) * r1))) + kotlin.math.exp(__pytra_float((((-8.0) * r2) * r2))))
    ...
    var l: Any? = kotlin.math.sqrt(__pytra_float((__pytra_float((__pytra_float(lx) * __pytra_float(lx))) + __pytra_float((__pytra_float(ly) * __pytra_float(ly))))))
...
fun run_14_raymarching_light_cycle() {
    ...
    while ((__step_0 >= 0L && t < __pytra_int(frames_n)) || (__step_0 < 0L && t > __pytra_int(frames_n))) {
        ...
        var a: Double = __pytra_float((((__pytra_float(t) / __pytra_float(frames_n)) * Math.PI) * 2.0))
        ...
        while ((__step_1 >= 0L && y < __pytra_int(h)) || (__step_1 < 0L && y > __pytra_int(h))) {
            ...
            var py: Double = __pytra_float((__pytra_float((__pytra_float((__pytra_float(y) / __pytra_float((__pytra_int(h) - __pytra_int(1L))))) * __pytra_float(2.0))) - __pytra_float(1.0)))
            val __step_2 = __pytra_int(1L)
            var x = __pytra_int(0L)
            while ((__step_2 >= 0L && x < __pytra_int(w)) || (__step_2 < 0L && x > __pytra_int(w))) {
                var px: Double = __pytra_float((__pytra_float((__pytra_float((__pytra_float(x) / __pytra_float((__pytra_int(w) - __pytra_int(1L))))) * __pytra_float(2.0))) - __pytra_float(1.0)))
