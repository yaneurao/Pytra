...
func render_mandelbrot(width: Int64, height: Int64, max_iter: Int64, x_min: Double, x_max: Double, y_min: Double, y_max: Double) -> [Any] {
    ...
    while ((__step_0 >= 0 && y < __pytra_int(height)) || (__step_0 < 0 && y > __pytra_int(height))) {
        var py: Double = __pytra_float((__pytra_float(y_min) + __pytra_float((__pytra_float((__pytra_float(y_max) - __pytra_float(y_min))) * __pytra_float((__pytra_float(y) / __pytra_float((__pytra_int(height) - __pytra_int(Int64(1))))))))))
        ...
        while ((__step_1 >= 0 && x < __pytra_int(width)) || (__step_1 < 0 && x > __pytra_int(width))) {
            var px: Double = __pytra_float((__pytra_float(x_min) + __pytra_float((__pytra_float((__pytra_float(x_max) - __pytra_float(x_min))) * __pytra_float((__pytra_float(x) / __pytra_float((__pytra_int(width) - __pytra_int(Int64(1))))))))))
