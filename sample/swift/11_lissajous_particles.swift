...
func run_11_lissajous_particles() {
    ...
    while ((__step_0 >= 0 && t < __pytra_int(frames_n)) || (__step_0 < 0 && t > __pytra_int(frames_n))) {
        ...
        while ((__step_1 >= 0 && p < __pytra_int(particles)) || (__step_1 < 0 && p > __pytra_int(particles))) {
            ...
            var x: Int64 = __pytra_int(__pytra_int(((__pytra_float(w) * __pytra_float(Double(0.5))) + ((__pytra_float(w) * __pytra_float(Double(0.38))) * sin(__pytra_float((__pytra_float((__pytra_float(Double(0.11)) * __pytra_float(t))) + __pytra_float((__pytra_float(phase) * __pytra_float(Double(2.0)))))))))))
            var y: Int64 = __pytra_int(__pytra_int(((__pytra_float(h) * __pytra_float(Double(0.5))) + ((__pytra_float(h) * __pytra_float(Double(0.38))) * sin(__pytra_float((__pytra_float((__pytra_float(Double(0.17)) * __pytra_float(t))) + __pytra_float((__pytra_float(phase) * __pytra_float(Double(3.0)))))))))))
