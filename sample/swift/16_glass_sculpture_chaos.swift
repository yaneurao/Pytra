...
func length(x: Double, y: Double, z: Double) -> Double {
    return __pytra_float(sqrt(__pytra_float(((x * x) + (y * y)) + (z * z))))
}
...
func normalize(x: Double, y: Double, z: Double) -> [Any] {
    ...
    return __pytra_as_list([(x / l), (y / l), (z / l)])
}

func reflect(ix: Double, iy: Double, iz: Double, nx: Double, ny: Double, nz: Double) -> [Any] {
    var d: Double = (dot(ix, iy, iz, nx, ny, nz) * Double(2.0))
    return __pytra_as_list([(ix - (d * nx)), (iy - (d * ny)), (iz - (d * nz))])
}
...
func refract(ix: Double, iy: Double, iz: Double, nx: Double, ny: Double, nz: Double, eta: Double) -> [Any] {
    ...
    return __pytra_as_list([((eta * ix) + (k * nx)), ((eta * iy) + (k * ny)), ((eta * iz) + (k * nz))])
}

func schlick(cos_theta: Double, f0: Double) -> Double {
    var m: Double = (Double(1.0) - cos_theta)
    return (f0 + ((Double(1.0) - f0) * ((((m * m) * m) * m) * m)))
}

func sky_color(dx: Double, dy: Double, dz: Double, tphase: Double) -> [Any] {
    var t: Double = (Double(0.5) * (dy + Double(1.0)))
    var r: Double = (Double(0.06) + (Double(0.2) * t))
    var g: Double = (Double(0.1) + (Double(0.25) * t))
    var b: Double = (Double(0.16) + (Double(0.45) * t))
    var band: Double = __pytra_float(Double(0.5) + (Double(0.5) * sin(__pytra_float(((Double(8.0) * dx) + (Double(6.0) * dz)) + tphase))))
    r += (Double(0.08) * band)
    g += (Double(0.05) * band)
    b += (Double(0.12) * band)
    return __pytra_as_list([clamp01(r), clamp01(g), clamp01(b)])
}
...
func palette_332() -> [Any] {
    ...
    while (i < __pytra_int(Int64(256))) {
        ...
        __pytra_setIndex(p, ((i * Int64(3)) + Int64(0)), __pytra_int(__pytra_float(Int64(255) * r) / __hoisted_cast_1))
        __pytra_setIndex(p, ((i * Int64(3)) + Int64(1)), __pytra_int(__pytra_float(Int64(255) * g) / __hoisted_cast_1))
...
func quantize_332(r: Double, g: Double, b: Double) -> Int64 {
    var rr: Int64 = __pytra_int(clamp01(r) * Double(255.0))
    var gg: Int64 = __pytra_int(clamp01(g) * Double(255.0))
    var bb: Int64 = __pytra_int(clamp01(b) * Double(255.0))
...
func render_frame(width: Int64, height: Int64, frame_id: Int64, frames_n: Int64) -> [Any] {
    ...
    var look_x: Double = Double(0.0)
    var look_y: Double = Double(0.35)
    var look_z: Double = Double(0.0)
    ...
    while (py < __pytra_int(height)) {
        ...
        var sy: Double = (Double(1.0) - ((Double(2.0) * (__pytra_float(py) + Double(0.5))) / __hoisted_cast_3))
        var px = __pytra_int(Int64(0))
        while (px < __pytra_int(width)) {
            var sx: Double = ((((Double(2.0) * (__pytra_float(px) + Double(0.5))) / __hoisted_cast_4) - Double(1.0)) * aspect)
            ...
            var best_t: Double = Double(1000000000.0)
            ...
            if (__pytra_int(hit_kind) == __pytra_int(Int64(0))) {
                ...
                if (__pytra_int(hit_kind) == __pytra_int(Int64(1))) {
                    ...
                    var cx: Int64 = __pytra_int(floor(__pytra_float(hx * Double(2.0))))
                    var cz: Int64 = __pytra_int(floor(__pytra_float(hz * Double(2.0))))
                    var checker: Int64 = __pytra_int(__pytra_ifexp((__pytra_int((cx + cz) % Int64(2)) == __pytra_int(Int64(0))), Int64(0), Int64(1)))
                    ...
                    var glow: Double = __pytra_float(Double(8.0) / __pytra_float(Double(1.0) + ldist2))
                    ...
                    var cz: Double = Double(0.0)
                    var rad: Double = Double(1.0)
                    ...
                    var hz: Double = __pytra_float(cam_z + (best_t * dz))
                    let __tuple_8 = __pytra_as_list(normalize((__pytra_float(hx - cx) / rad), (__pytra_float(hy - cy) / rad), (__pytra_float(hz - cz) / rad)))
                    ...
                    let __tuple_10 = __pytra_as_list(refract(dx, dy, dz, nx, ny, nz, (Double(1.0) / Double(1.45))))
                    ...
                    spec = __pytra_int(spec * spec)
                    spec = __pytra_int(spec * spec)
                    var glow: Double = __pytra_float(Double(10.0) / __pytra_float(((Double(1.0) + (lxv * lxv)) + (lyv * lyv)) + (lzv * lzv)))
            ...
            __pytra_setIndex(frame, (row_base + px), quantize_332(r, g, b))
            px += 1
        }
        py += 1
    }
