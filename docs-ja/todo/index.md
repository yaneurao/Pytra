...
7. [x] [ID: P2-RUBY-BACKEND-01-S3-02] `sample/ruby` 再生成、README バッジ/対応表、`docs-ja/how-to-use.md` と `docs/how-to-use.md` の手順を同期する。
...
- `P2-RUBY-BACKEND-01-S3-02` `sample/ruby` 18件を再生成し、`readme-ja.md/readme.md` の Ruby バッジ/対応記載と `docs-ja/how-to-use.md/docs/how-to-use.md` の Ruby 実行手順を同期した。
