...
def _write_js_selfhost_shims(stage_src_root: Path) -> None:
    files: dict[str, str] = {
        ...
        "pytra/std/pathlib.js": (
            "import { createRequire } from 'node:module';\n"
            "const require = createRequire(import.meta.url);\n"
            "const rt = require('../../runtime/js/generated/std/pathlib.js');\n"
            "export const Path = rt.Path;\n"
            "export const pathJoin = rt.pathJoin;\n"
        ),
        "pytra/std/math.js": (
            "import { createRequire } from 'node:module';\n"
            "const require = createRequire(import.meta.url);\n"
            "const rt = require('../../runtime/js/generated/std/math.js');\n"
        ...
        "pytra/std/time.js": (
            "import { createRequire } from 'node:module';\n"
            "const require = createRequire(import.meta.url);\n"
            "const rt = require('../../runtime/js/generated/std/time.js');\n"
