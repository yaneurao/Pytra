...
from toolchain.compiler.relative_import_php_support_contract import (
...
EXPECTED_SMOKE = {
    ...
    "focused_tests": (
        "test_cli_relative_import_support_rollout_fail_closed_for_php",
...
def validate_relative_import_php_support_contract() -> None:
    ...
    emitter_path = ROOT / "src/backends/php/emitter/php_native_emitter.py"
