#!/usr/bin/env python3
"""Compatibility wrapper for check_py2swift_transpile; delegates to check_py2x_transpile.py."""
...
def main() -> int:
    ap = argparse.ArgumentParser(description="compat wrapper: check_py2swift_transpile")
