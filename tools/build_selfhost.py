...
def build_selfhost_multimod_transpile_cmd(selfhost_entry: Path, output_dir: Path) -> list[str]:
    return [
        "python3",
...
def main() -> int:
    ...
    if multi_module:
        ...
        run(build_selfhost_multimod_transpile_cmd(SELFHOST_ENTRY, multimod_dir))
        # For multi-module, the Makefile is generated by the pipeline
        # Just need to run make in the output directory
