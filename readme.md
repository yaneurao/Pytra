...
|02_raytrace_spheres|球の簡易レイトレーサ（PNG）|5.132|0.142|0.153|0.865|🚧|🚧|
|03_julia_set|ジュリア集合（PNG）|13.578|0.794|0.670|3.395|🚧|🚧|
|04_monte_carlo_pi|モンテカルロ法で円周率近似|10.921|0.155|0.197|0.601|🚧|🚧|
...
|07_game_of_life_loop|ライフゲーム（GIF）|13.410|0.717|1.491|3.167|🚧|🚧|
|08_langtons_ant|ラングトンのアリ（GIF）|7.431|0.483|1.853|2.233|🚧|🚧|
|09_fire_simulation|炎シミュレーション（GIF）|1.088|0.054|0.435|0.522|🚧|🚧|
|10_plasma_effect|プラズマエフェクト（GIF）|7.640|0.673|0.537|2.356|🚧|🚧|
|11_lissajous_particles|リサージュ粒子（GIF）|5.250|0.382|0.344|0.754|🚧|🚧|
|12_sort_visualizer|ソート可視化（GIF）|11.451|0.723|0.657|1.852|🚧|🚧|
