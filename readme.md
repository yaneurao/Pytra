...
|ファイル名|内容|Python| C++ | Rust | C# | JS | TS | Go | Java | Swift | Kotlin |
|-|-|-:|-:|-:|-:|-:|-:|-:|-:|-:|-:|
|01_mandelbrot|マンデルブロ集合（PNG）|16.175|0.754|0.719|2.549|1.519|1.489|16.154|16.387|-|-|
|02_raytrace_spheres|球の簡易レイトレーサ（PNG）|5.132|0.108|0.155|0.865|0.436|0.460|5.455|5.444|-|-|
|03_julia_set|ジュリア集合（PNG）|13.578|0.808|0.675|3.395|1.816|1.834|13.311|13.423|-|-|
|04_monte_carlo_pi|モンテカルロ法で円周率近似|10.921|0.161|0.197|0.601|2.118|2.153|11.203|11.298|-|-|
|05_mandelbrot_zoom|マンデルブロズーム（GIF）|13.802|0.544|0.539|2.694|1.193|1.243|15.237|14.874|-|-|
|06_julia_parameter_sweep|ジュリア集合パラメータ掃引（GIF）|9.825|0.386|0.387|1.929|0.981|0.997|9.796|10.012|-|-|
|07_game_of_life_loop|ライフゲーム（GIF）|13.645|0.692|0.722|3.272|2.750|2.949|13.968|13.876|-|-|
|08_langtons_ant|ラングトンのアリ（GIF）|7.431|0.471|0.453|2.233|1.946|2.145|7.797|7.643|-|-|
|09_fire_simulation|炎シミュレーション（GIF）|13.649|0.625|0.607|6.488|2.480|2.525|14.614|14.941|-|-|
|10_plasma_effect|プラズマエフェクト（GIF）|7.640|0.527|0.529|2.356|1.539|2.156|7.475|7.609|-|-|
|11_lissajous_particles|リサージュ粒子（GIF）|5.250|0.350|0.343|0.754|1.535|1.598|5.244|5.406|-|-|
|12_sort_visualizer|ソート可視化（GIF）|11.451|0.648|0.684|1.852|3.098|3.249|11.627|11.691|-|-|
|13_maze_generation_steps|迷路生成ステップ（GIF）|4.716|0.283|0.274|0.946|1.069|1.162|4.927|4.961|-|-|
|14_raymarching_light_cycle|簡易レイマーチング（GIF）|2.666|0.123|0.149|0.467|0.505|0.761|2.779|2.793|-|-|
|15_mini_language_interpreter|ミニ言語インタプリタ |2.207|0.600|0.789|1.035|0.509|0.465|2.541|2.522|-|-|
|16_glass_sculpture_chaos|ガラス彫刻のカオス回転（GIF）|7.114|0.205|0.231|1.289|0.940|1.105|7.714|7.667|-|-|
