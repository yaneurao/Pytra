...
- For C++, comment-based passthrough is available.
  ...
  - See `docs-en/spec-east.md` for details.
...
- py2cpp feature support matrix (with test evidence): `docs-en/spec-py2cpp-support.md`
- Sample code: `docs-en/sample-code.md`
- Detailed implementation status: `docs-en/pytra-readme.md`
