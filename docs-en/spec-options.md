...
1. `docs-en/spec-options.md` (option definitions, defaults, presets)
2. `docs-en/spec-dev.md` (implementation specification and CLI reflection)
3. `docs-en/spec-east.md` (responsibility boundary between EAST side and generator side)
