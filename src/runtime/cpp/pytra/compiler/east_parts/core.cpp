...
namespace pytra::compiler::east_parts::core {
    ...
    rc<EastBuildError> _make_east_build_error(const str& kind, const str& message, const dict<str, object>& source_span, const str& hint) {
        /* self-hosted 生成で引数欠落しないよう、例外生成を関数経由に統一する。 */
        return ::rc_new<EastBuildError>(kind, message, source_span, hint);
    }
    ...
    ::std::optional<dict<str, object>> _sh_parse_def_sig(int64 ln_no, const str& ln, const str& in_class = "") {
        ...
        ::std::optional<rc<pytra::std::re::Match>> m_def = pytra::std::re::match("^def\\s+([A-Za-z_][A-Za-z0-9_]*)\\((.*)\\)\\s*(?:->\\s*(.+)\\s*)?:\\s*$", ln_norm);
        if (py_is_none(m_def))
            return ::std::nullopt;
        dict<str, str> arg_types = dict<str, str>{};
        list<str> arg_order = list<str>{};
        dict<str, str> arg_defaults = dict<str, str>{};
        str args_raw = pytra::std::re::group(m_def, 2);
        if (py_strip(args_raw) != "") {
            ...
            for (auto __it_3 : _sh_split_args_with_offsets(args_raw)) {
                auto p_txt = ::std::get<0>(__it_3);
                auto _off = ::std::get<1>(__it_3);
                ...
                ::std::optional<rc<pytra::std::re::Match>> m_param = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_]*)\\s*:\\s*([^=]+?)(?:\\s*=\\s*(.+))?$", p);
                if (py_is_none(m_param))
                ...
                str pn = pytra::std::re::strip_group(m_param, 1);
                str pt = pytra::std::re::strip_group(m_param, 2);
                ...
                str pdef = pytra::std::re::group(m_param, 3);
                if (pdef != "") {
        ...
        str ret_group = pytra::std::re::group(m_def, 3);
        dict<str, object> out_sig = dict<str, object>{};
        out_sig[py_to_string("name")] = make_object(pytra::std::re::group(m_def, 1));
    ...
    ::std::tuple<list<::std::tuple<int64, str>>, dict<int64, ::std::tuple<int64, int64>>> _sh_merge_logical_lines(const list<::std::tuple<int64, str>>& raw_lines) {
        ...
        while (idx < py_len(raw_lines)) {
            auto __tuple_4 = raw_lines[idx];
            int64 start_no = ::std::get<0>(__tuple_4);
            str start_txt = ::std::get<1>(__tuple_4);
            str acc = start_txt;
            int64 depth = 0;
            str mode = "";
            auto __tuple_5 = _sh_scan_logical_line_state(start_txt, depth, mode);
            depth = ::std::get<0>(__tuple_5);
            mode = ::std::get<1>(__tuple_5);
            int64 end_no = start_no;
            str end_txt = start_txt;
            while (((depth > 0) || (py_contains(set<str>{"'''", "\"\"\""}, mode))) && (idx + 1 < py_len(raw_lines))) {
                idx++;
                auto __tuple_6 = raw_lines[idx];
                int64 next_no = ::std::get<0>(__tuple_6);
                str next_txt = ::std::get<1>(__tuple_6);
                if (py_contains(set<str>{"'''", "\"\"\""}, mode))
                    acc += "\n" + next_txt;
                else
                    acc += " " + py_strip(next_txt);
                auto __tuple_7 = _sh_scan_logical_line_state(next_txt, depth, mode);
                depth = ::std::get<0>(__tuple_7);
                mode = ::std::get<1>(__tuple_7);
                end_no = next_no;
                end_txt = next_txt;
            }
    ...
    list<str> _sh_split_top_commas(const str& txt) {
        ...
        bool esc = false;
        int64 start = 0;
        for (auto __it_8 : py_enumerate(txt)) {
            auto i = ::std::get<0>(__it_8);
            auto ch = ::std::get<1>(__it_8);
            if (!py_is_none(in_str)) {
                if (esc) {
                    esc = false;
                    continue;
    ...
    list<str> _sh_split_top_plus(const str& text) {
        ...
        bool esc = false;
        int64 start = 0;
        for (auto __it_9 : py_enumerate(text)) {
            auto i = ::std::get<0>(__it_9);
            auto ch = ::std::get<1>(__it_9);
            if (!py_is_none(in_str)) {
                if (esc) {
                    esc = false;
                    continue;
    ...
    str _sh_infer_item_type(const dict<str, object>& node) {
        ...
        str t = py_to_string(py_dict_get_default(node, py_to_string("resolved_type"), "unknown"));
        if (t == "range")
            return "int64";
    ...
    dict<str, str> _sh_bind_comp_target_types(const dict<str, str>& base_types, const dict<str, object>& target_node, const dict<str, object>& iter_node) {
        ...
        if (py_dict_get(target_node, py_to_string("kind")) == "Name") {
            str nm = py_to_string(py_dict_get_default(target_node, py_to_string("id"), ""));
            if (nm != "")
                out[py_to_string(nm)] = item_t;
            return out;
        }
        if (py_dict_get(target_node, py_to_string("kind")) != "Tuple")
            return out;
        auto elem_nodes = py_dict_get_default(target_node, py_to_string("elements"), list<object>{});
        ...
        while (i < py_len(elem_nodes)) {
            ...
            if ((py_is_dict(e)) && (py_dict_get(e, "kind") == "Name")) {
    ...
    dict<str, int64> _sh_block_end_span(const list<::std::tuple<int64, str>>& body_lines, int64 start_ln, int64 start_col, int64 fallback_end_col, int64 end_idx_exclusive) {
        ...
        if ((end_idx_exclusive > 0) && (end_idx_exclusive - 1 < py_len(body_lines))) {
            auto __tuple_10 = body_lines[end_idx_exclusive - 1];
            int64 end_ln = ::std::get<0>(__tuple_10);
            str end_txt = ::std::get<1>(__tuple_10);
    ...
    int64 _sh_push_stmt_with_trivia(list<dict<str, object>>& stmts, list<dict<str, object>>& pending_leading_trivia, int64 pending_blank_count, dict<str, object>& stmt) {
        ...
        if (py_len(pending_leading_trivia) > 0) {
            stmt[py_to_string("leading_trivia")] = make_object(pending_leading_trivia);
            list<object> comments = [&]() -> list<object> {     list<object> __out;     for (auto x : pending_leading_trivia) {         if ((py_dict_get(x, py_to_string("kind")) == "comment") && (py_is_str(py_dict_get(x, py_to_string("text"))))) __out.append(py_dict_get(x, py_to_string("text")));     }     return __out; }();
            if (py_len(comments) > 0)
                stmt[py_to_string("leading_comments")] = make_object(comments);
            pending_leading_trivia.clear();
        }
        stmts.append(dict<str, object>(stmt));
    ...
    ::std::tuple<list<::std::tuple<int64, str>>, int64> _sh_collect_indented_block(const list<::std::tuple<int64, str>>& body_lines, int64 start, int64 parent_indent) {
        ...
        while (j < py_len(body_lines)) {
            auto __tuple_12 = body_lines[j];
            int64 n_no = ::std::get<0>(__tuple_12);
            str n_ln = ::std::get<1>(__tuple_12);
            if (py_strip(n_ln) == "") {
                int64 t = j + 1;
    ...
    str _sh_strip_inline_comment(const str& text) {
        ...
        ::std::optional<str> in_str = ::std::nullopt;
        bool esc = false;
        for (auto __it_13 : py_enumerate(text)) {
            auto i = ::std::get<0>(__it_13);
            auto ch = ::std::get<1>(__it_13);
            if (!py_is_none(in_str)) {
                if (esc) {
                    esc = false;
                } else {
    ...
    ::std::tuple<list<dict<str, object>>, int64> _sh_parse_if_tail(int64 start_idx, int64 parent_indent, const list<::std::tuple<int64, str>>& body_lines, const dict<str, str>& name_types, const str& scope_label) {
        ...
        auto __tuple_14 = body_lines[start_idx];
        int64 t_no = ::std::get<0>(__tuple_14);
        str t_ln = ::std::get<1>(__tuple_14);
        int64 t_indent = py_len(t_ln) - py_len(py_lstrip(t_ln, " "));
        auto t_s = py_strip(t_ln);
        if (t_indent != parent_indent)
            return ::std::make_tuple(list<object>{}, start_idx);
        if (t_s == "else:") {
            auto __tuple_15 = _sh_collect_indented_block(body_lines, start_idx + 1, parent_indent);
            list<::std::tuple<int64, str>> else_block = ::std::get<0>(__tuple_15);
            int64 k2 = ::std::get<1>(__tuple_15);
        ...
        if ((py_startswith(t_s, "elif ")) && (py_endswith(t_s, ":"))) {
            ...
            auto __tuple_16 = _sh_collect_indented_block(body_lines, start_idx + 1, parent_indent);
            list<::std::tuple<int64, str>> elif_block = ::std::get<0>(__tuple_16);
            int64 k2 = ::std::get<1>(__tuple_16);
            ...
            auto __tuple_17 = _sh_parse_if_tail(k2, parent_indent, body_lines, name_types, scope_label);
            list<dict<str, object>> nested_orelse = ::std::get<0>(__tuple_17);
            int64 k3 = ::std::get<1>(__tuple_17);
    ...
    ::std::tuple<::std::optional<str>, list<dict<str, object>>> _sh_extract_leading_docstring(const list<dict<str, object>>& stmts) {
        ...
        if ((!(py_is_dict(first))) || (py_dict_get(first, py_to_string("kind")) != "Expr"))
            return ::std::make_tuple(::std::nullopt, stmts);
        auto val = py_dict_get(first, py_to_string("value"));
        if ((!(py_is_dict(val))) || (py_dict_get(val, "kind") != "Constant"))
            return ::std::make_tuple(::std::nullopt, stmts);
        auto s = py_dict_get(val, "value");
        if (!(py_is_str(s)))
            return ::std::make_tuple(::std::nullopt, stmts);
    ...
    struct _ShExprParser : public PyObj {
        str src;
        int64 line_no;
        int64 col_base;
        ...
        dict<str, object> _parse_lambda() {
            ...
            str body_t = py_to_string(py_dict_get_default(body, py_to_string("resolved_type"), "unknown"));
        ...
        dict<str, object> _parse_ifexp() {
            ...
            if ((py_dict_get(this->_cur(), py_to_string("k")) == "NAME") && (py_dict_get(this->_cur(), py_to_string("v")) == "if")) {
                ...
                str rt = py_to_string(py_dict_get_default(body, py_to_string("resolved_type"), "unknown"));
                if (rt != py_to_string(py_dict_get_default(orelse, py_to_string("resolved_type"), "unknown")))
                    rt = "unknown";
        ...
        dict<str, object> _parse_unary() {
            ...
            if (py_contains(set<str>{"+", "-"}, py_dict_get(this->_cur(), py_to_string("k")))) {
                ...
                object s = make_object(py_dict_get(tok, py_to_string("s")));
                int64 e = py_to_int64(py_dict_get(py_dict_get(operand, py_to_string("source_span")), "end_col")) - this->col_base;
                str out_t = py_to_string(py_dict_get_default(operand, py_to_string("resolved_type"), "unknown"));
        ...
        list<str> _split_generic_types(const str& s) {
            ...
            int64 depth = 0;
            int64 start = 0;
            for (auto __it_21 : py_enumerate(s)) {
                auto i = ::std::get<0>(__it_21);
                auto ch = ::std::get<1>(__it_21);
                if (ch == "[") {
                    depth++;
                } else {
                    if (ch == "]") {
        ...
        list<str> _split_union_types(const str& s) {
            ...
            int64 depth = 0;
            int64 start = 0;
            for (auto __it_22 : py_enumerate(s)) {
                auto i = ::std::get<0>(__it_22);
                auto ch = ::std::get<1>(__it_22);
                if (ch == "[") {
                    depth++;
                } else {
                    if (ch == "]") {
        ...
        dict<str, object> _parse_postfix() {
            ...
            while (true) {
                ...
                if (py_dict_get(tok, py_to_string("k")) == ".") {
                    ...
                    str owner_t = py_to_string(py_dict_get_default(node, py_to_string("resolved_type"), "unknown"));
                    ...
                    str attr_t = "unknown";
                    if ((py_is_dict(node)) && (py_dict_get(node, py_to_string("kind")) == "Name") && (py_dict_get(node, py_to_string("id")) == "self")) {
                        // In method scope, class fields are injected into name_types.
                        auto maybe_field_t = py_dict_get(this->name_types, py_to_string(attr_name));
                ...
                if (py_dict_get(tok, py_to_string("k")) == "(") {
                    ...
                    str fn_name = "";
                    if ((py_is_dict(node)) && (py_dict_get(node, py_to_string("kind")) == "Name")) {
                        fn_name = py_to_string(py_dict_get_default(node, py_to_string("id"), ""));
                        if (fn_name == "print") {
                            call_ret = "None";
                        } else {
                            if (fn_name == "Path") {
                        ...
                        if ((py_is_dict(node)) && (py_dict_get(node, py_to_string("kind")) == "Attribute")) {
                            auto owner = py_dict_get(node, py_to_string("value"));
                            str attr = py_to_string(py_dict_get_default(node, py_to_string("attr"), ""));
                            if ((py_is_dict(owner)) && (py_dict_get(owner, "kind") == "Name")) {
                            ...
                            if ((py_is_dict(node)) && (py_dict_get(node, py_to_string("kind")) == "Lambda"))
                                call_ret = py_to_string(py_dict_get_default(node, py_to_string("return_type"), "unknown"));
                        }
                    }
                                                        ...
                                                        if (py_contains(set<str>{"bytes", "bytearray"}, fn_name)) {
                                                            ...
                                                            if ((py_is_dict(node)) && (py_dict_get(node, py_to_string("kind")) == "Attribute")) {
                                                                ...
                                                                if (owner_t == "str") {
                                                                    ...
                                                                    rc = make_object(py_dict_get(str_map, py_to_string(attr)));
                                                                    if (!py_is_none(rc)) {
                                                                        payload[py_to_string("lowered_kind")] = make_object("BuiltinCall");
                                                                    ...
                                                                    if (owner_t == "Path") {
                                                                        ...
                                                                        rc = make_object(py_dict_get(path_map, py_to_string(attr)));
                                                                        if (!py_is_none(rc)) {
                                                                            payload[py_to_string("lowered_kind")] = make_object("BuiltinCall");
                                                                            payload[py_to_string("builtin_name")] = make_object(attr);
                                                                            payload[py_to_string("runtime_call")] = make_object(rc);
                                                                        ...
                                                                        if ((py_contains(INT_TYPES, owner_t)) || (owner_t == "int")) {
                                                                            ...
                                                                            rc = make_object(py_dict_get(int_map, py_to_string(attr)));
                                                                            if (!py_is_none(rc)) {
                                                                                payload[py_to_string("lowered_kind")] = make_object("BuiltinCall");
                                                                                payload[py_to_string("builtin_name")] = make_object(attr);
                                                                                payload[py_to_string("runtime_call")] = make_object(rc);
                                                                            ...
                                                                            if (py_startswith(owner_t, "list[")) {
                                                                                ...
                                                                                rc = make_object(py_dict_get(list_map, py_to_string(attr)));
                                                                                if (!py_is_none(rc)) {
                                                                                    payload[py_to_string("lowered_kind")] = make_object("BuiltinCall");
                                                                                    payload[py_to_string("builtin_name")] = make_object(attr);
                                                                                    payload[py_to_string("runtime_call")] = make_object(rc);
                                                                                ...
                                                                                if (py_startswith(owner_t, "set[")) {
                                                                                    ...
                                                                                    rc = make_object(py_dict_get(set_map, py_to_string(attr)));
                                                                                    if (!py_is_none(rc)) {
                                                                                        payload[py_to_string("lowered_kind")] = make_object("BuiltinCall");
                                                                                        payload[py_to_string("builtin_name")] = make_object(attr);
                                                                                        payload[py_to_string("runtime_call")] = make_object(rc);
                                                                                    ...
                                                                                    if (py_startswith(owner_t, "dict[")) {
                                                                                        ...
                                                                                        rc = make_object(py_dict_get(dict_map, py_to_string(attr)));
                                                                                        if (!py_is_none(rc)) {
                                                                                            payload[py_to_string("lowered_kind")] = make_object("BuiltinCall");
                                                                                            payload[py_to_string("builtin_name")] = make_object(attr);
                                                                                            payload[py_to_string("runtime_call")] = make_object(rc);
                                                                                        ...
                                                                                        if (owner_t == "unknown") {
                                                                                            ...
                                                                                            rc = make_object(py_dict_get(unknown_map, py_to_string(attr)));
                                                                                            if (!py_is_none(rc)) {
                                                                                                payload[py_to_string("lowered_kind")] = make_object("BuiltinCall");
                                                                                                payload[py_to_string("builtin_name")] = make_object(attr);
                                                                                                payload[py_to_string("runtime_call")] = make_object(rc);
                ...
                if (py_dict_get(tok, py_to_string("k")) == "[") {
                    ...
                    if (py_dict_get(this->_cur(), py_to_string("k")) == ":") {
                        ...
                        int64 s = py_to_int64(py_dict_get(py_dict_get(node, py_to_string("source_span")), "col")) - this->col_base;
                        object e = make_object(py_dict_get(rtok, py_to_string("e")));
                        node = dict<str, object>{{"kind", make_object("Subscript")}, {"source_span", make_object(this->_node_span(s, int64(py_to_int64(e))))}, {"resolved_type", make_object(py_dict_get_default(node, py_to_string("resolved_type"), "unknown"))}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(this->_src_slice(s, int64(py_to_int64(e))))}, {"value", make_object(node)}, {"slice", make_object(dict<str, object>{{"kind", make_object("Slice")}, {"lower", make_object(::std::nullopt)}, {"upper", make_object(up)}, {"step", make_object(::std::nullopt)}})}, {"lowered_kind", make_object("SliceExpr")}, {"lower", make_object(::std::nullopt)}, {"upper", make_object(up)}};
                        continue;
                    }
                    ...
                    int64 s = py_to_int64(py_dict_get(py_dict_get(node, py_to_string("source_span")), "col")) - this->col_base;
                    object e = make_object(py_dict_get(rtok, py_to_string("e")));
                    str out_t = this->_subscript_result_type(py_to_string(py_dict_get_default(node, py_to_string("resolved_type"), "unknown")));
        ...
        dict<str, object> _parse_call_arg_expr() {
            ...
            return dict<str, object>{{"kind", make_object("ListComp")}, {"source_span", make_object(this->_node_span(s, e))}, {"resolved_type", make_object("list[" + py_to_string(py_dict_get_default(first, py_to_string("resolved_type"), "unknown")) + "]")}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(this->_src_slice(s, e))}, {"elt", make_object(first)}, {"generators", make_object(list<dict<str, object>>{dict<str, object>{{"target", make_object(target)}, {"iter", make_object(iter_expr)}, {"ifs", make_object(ifs)}, {"is_async", make_object(false)}}})}, {"lowered_kind", make_object("GeneratorArg")}};
        }
        dict<str, object> _make_bin(const dict<str, object>& left, const str& op_sym, const dict<str, object>& right) {
            ...
            str lt = py_to_string(py_dict_get_default(left, py_to_string("resolved_type"), "unknown"));
            str rt = py_to_string(py_dict_get_default(right, py_to_string("resolved_type"), "unknown"));
        ...
        dict<str, object> _parse_primary() {
            ...
            if (py_dict_get(tok, py_to_string("k")) == "(") {
                ...
                if (py_dict_get(this->_cur(), py_to_string("k")) == ",") {
                    ...
                    dict<str, object> r = this->_eat(")");
                    list<str> elem_types = [&]() -> list<str> {     list<str> __out;     for (auto e : elements) {         __out.append(py_to_string(py_dict_get_default(e, py_to_string("resolved_type"), "unknown")));     }     return __out; }();
            ...
            if (py_dict_get(tok, py_to_string("k")) == "[") {
                ...
                if (py_dict_get(this->_cur(), py_to_string("k")) != "]") {
                    ...
                    if ((py_dict_get(this->_cur(), py_to_string("k")) == "NAME") && (py_dict_get(this->_cur(), py_to_string("v")) == "for")) {
                        ...
                        dict<str, object> iter_expr = this->_parse_ifexp();
                        if ((py_is_dict(iter_expr)) && (py_dict_get(iter_expr, py_to_string("kind")) == "Call") && (py_is_dict(py_dict_get(iter_expr, py_to_string("func")))) && (py_dict_get(py_dict_get_default(iter_expr, py_to_string("func"), dict<str, object>{}), "kind") == "Name") && (py_dict_get(py_dict_get_default(iter_expr, py_to_string("func"), dict<str, object>{}), "id") == "range")) {
                            list<object> rargs = py_dict_get_default(iter_expr, py_to_string("args"), list<object>{});
                            ...
                            if (py_is_dict(step_node))
                                step_const_obj = make_object(py_dict_get(step_node, py_to_string("value")));
                            ...
                            iter_expr = dict<str, object>{{"kind", make_object("RangeExpr")}, {"source_span", make_object(py_dict_get(iter_expr, py_to_string("source_span")))}, {"resolved_type", make_object("range")}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(py_dict_get_default(iter_expr, py_to_string("repr"), "range(...)"))}, {"start", make_object(start_node)}, {"stop", make_object(stop_node)}, {"step", make_object(step_node)}, {"range_mode", make_object(mode)}};
                        }
                        list<dict<str, object>> ifs = list<dict<str, object>>{};
                        while ((py_dict_get(this->_cur(), py_to_string("k")) == "NAME") && (py_dict_get(this->_cur(), py_to_string("v")) == "if")) {
                            this->_eat("NAME");
                        ...
                        if (tgt_ty != "unknown") {
                            ...
                            auto first_repr = py_dict_get(first, py_to_string("repr"));
                            int64 first_col = py_to_int64(py_dict_get_default(py_dict_get_default(first, py_to_string("source_span"), dict<str, object>{}), "col", this->col_base));
                            ...
                            for (dict<str, object> cond : ifs) {
                                auto cond_repr = py_dict_get(cond, py_to_string("repr"));
                                int64 cond_col = py_to_int64(py_dict_get_default(py_dict_get_default(cond, py_to_string("source_span"), dict<str, object>{}), "col", this->col_base));
                        ...
                        return dict<str, object>{{"kind", make_object("ListComp")}, {"source_span", make_object(this->_node_span(int64(py_to_int64(py_dict_get(l, py_to_string("s")))), int64(py_to_int64(py_dict_get(r, py_to_string("e"))))))}, {"resolved_type", make_object("list[" + py_to_string(py_dict_get_default(first_norm, py_to_string("resolved_type"), "unknown")) + "]")}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(this->_src_slice(int64(py_to_int64(py_dict_get(l, py_to_string("s")))), int64(py_to_int64(py_dict_get(r, py_to_string("e"))))))}, {"elt", make_object(first_norm)}, {"generators", make_object(list<dict<str, object>>{dict<str, object>{{"target", make_object(dict<str, object>{{"kind", make_object("Name")}, {"source_span", make_object(this->_node_span(int64(py_to_int64(py_dict_get(tgt_tok, py_to_string("s")))), int64(py_to_int64(py_dict_get(tgt_tok, py_to_string("e"))))))}, {"resolved_type", make_object(tgt_ty)}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(tgt_name)}, {"id", make_object(tgt_name)}})}, {"iter", make_object(iter_expr)}, {"ifs", make_object(ifs_norm)}}})}};
                    }
                ...
                if (py_len(elements) > 0) {
                    et = py_to_string(py_dict_get_default(elements[0], py_to_string("resolved_type"), "unknown"));
                    for (dict<str, object> e : py_slice(elements, 1, py_len(elements))) {
                        if (py_to_string(py_dict_get_default(e, py_to_string("resolved_type"), "unknown")) != et) {
                            et = "unknown";
                            break;
                        }
                    }
            ...
            if (py_dict_get(tok, py_to_string("k")) == "{") {
                ...
                if (py_dict_get(this->_cur(), py_to_string("k")) == ":") {
                    ...
                    dict<str, object> r = this->_eat("}");
                    str kt = (py_len(keys) > 0 ? py_to_string(py_dict_get_default(keys[0], py_to_string("resolved_type"), "unknown")) : "unknown");
                    str vt = (py_len(vals) > 0 ? py_to_string(py_dict_get_default(vals[0], py_to_string("resolved_type"), "unknown")) : "unknown");
                ...
                dict<str, object> r = this->_eat("}");
                str et = (py_len(elements) > 0 ? py_to_string(py_dict_get_default(elements[0], py_to_string("resolved_type"), "unknown")) : "unknown");
    ...
    dict<str, object> _sh_parse_expr(const str& text, int64 line_no, int64 col_base, const dict<str, str>& name_types, const dict<str, str>& fn_return_types, const dict<str, dict<str, str>>& class_method_return_types, const dict<str, ::std::optional<str>>& class_base) {
        ...
        rc<_ShExprParser> parser = ::rc_new<_ShExprParser>(txt, line_no, col_base + py_len(text) - py_len(py_lstrip(text)), name_types, fn_return_types, class_method_return_types, class_base);
        return parser->parse();
    }
    ...
    dict<str, object> _sh_parse_expr_lowered(const str& expr_txt, int64 ln_no, int64 col, const dict<str, str>& name_types) {
        ...
        if ((p_if >= 0) && (p_else > p_if)) {
            ...
            object rt_obj = make_object(py_dict_get_default(body_node, py_to_string("resolved_type"), "unknown"));
            str rt = (py_is_str(rt_obj) ? py_to_string(rt_obj) : "unknown");
            object else_rt_obj = make_object(py_dict_get_default(else_node, py_to_string("resolved_type"), "unknown"));
        ...
        if (py_endswith(txt, ")")) {
            ...
            int64 open_idx = -1;
            int64 close_idx = -1;
            for (auto __it_25 : py_enumerate(txt)) {
                auto idx = ::std::get<0>(__it_25);
        ...
        if ((py_startswith(txt, "{")) && (py_endswith(txt, "}")) && (py_contains(txt, ":"))) {
            ...
            if (p_for > 0) {
                ...
                auto __tuple_28 = head.split(":", 1);
                auto ktxt = py_at(__tuple_28, 0);
                auto vtxt = py_at(__tuple_28, 1);
                ktxt = py_strip(ktxt);
                vtxt = py_strip(vtxt);
                ...
                str kt = py_to_string(py_dict_get_default(key_node, py_to_string("resolved_type"), "unknown"));
                str vt = py_to_string(py_dict_get_default(val_node, py_to_string("resolved_type"), "unknown"));
        ...
        if ((py_startswith(txt, "{")) && (py_endswith(txt, "}")) && (!py_contains(txt, ":"))) {
            ...
            if (p_for > 0) {
                ...
                if (if_txt != "")
                    if_nodes.append(dict<str, object>(_sh_parse_expr_lowered(if_txt, ln_no, col + txt.find(if_txt), comp_types)));
                return dict<str, object>{{"kind", make_object("SetComp")}, {"source_span", make_object(_sh_span(ln_no, col, col + py_len(raw)))}, {"resolved_type", make_object("set[" + py_to_string(py_dict_get_default(elt_node, py_to_string("resolved_type"), "unknown")) + "]")}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(txt)}, {"elt", make_object(elt_node)}, {"generators", make_object(list<dict<str, object>>{dict<str, object>{{"target", make_object(target_node)}, {"iter", make_object(iter_node)}, {"ifs", make_object(if_nodes)}, {"is_async", make_object(false)}}})}};
            }
        }
        ...
        if ((py_startswith(txt, "{")) && (py_endswith(txt, "}")) && (py_contains(txt, ":"))) {
            ...
            if (inner != "") {
                for (str part : _sh_split_top_commas(inner)) {
                    ...
                    auto __tuple_29 = part.split(":", 1);
                    auto ktxt = py_at(__tuple_29, 0);
                    auto vtxt = py_at(__tuple_29, 1);
                    ktxt = py_strip(ktxt);
                    vtxt = py_strip(vtxt);
            ...
            if (py_len(entries) > 0) {
                ...
                kt = py_to_string(py_dict_get_default(first_key, py_to_string("resolved_type"), "unknown"));
                vt = py_to_string(py_dict_get_default(first_value, py_to_string("resolved_type"), "unknown"));
            }
        ...
        if ((py_startswith(txt, "[")) && (py_endswith(txt, "]"))) {
            ...
            if (p_for > 0) {
                ...
                dict<str, object> target_node = _sh_parse_expr_lowered(tgt_txt, ln_no, col + txt.find(tgt_txt), name_types);
                dict<str, object> iter_node = _sh_parse_expr_lowered(py_to_string(iter_txt), ln_no, col + txt.find(iter_txt), name_types);
                if ((py_is_dict(iter_node)) && (py_dict_get(iter_node, py_to_string("kind")) == "Call") && (py_is_dict(py_dict_get(iter_node, py_to_string("func")))) && (py_dict_get(py_dict_get_default(iter_node, py_to_string("func"), dict<str, object>{}), "kind") == "Name") && (py_dict_get(py_dict_get_default(iter_node, py_to_string("func"), dict<str, object>{}), "id") == "range")) {
                    list<object> rargs = py_dict_get_default(iter_node, py_to_string("args"), list<object>{});
                    dict<str, str> start_node;
                    object stop_node;
                    dict<str, str> step_node;
                    if (py_len(rargs) == 1) {
                    ...
                    iter_node = dict<str, object>{{"kind", make_object("RangeExpr")}, {"source_span", make_object(py_dict_get(iter_node, py_to_string("source_span")))}, {"resolved_type", make_object("range")}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(py_dict_get_default(iter_node, py_to_string("repr"), "range(...)"))}, {"start", make_object(start_node)}, {"stop", make_object(stop_node)}, {"step", make_object(step_node)}, {"range_mode", make_object(mode)}};
                }
                ...
                if (if_txt != "")
                    if_nodes.append(dict<str, object>(_sh_parse_expr_lowered(if_txt, ln_no, col + txt.find(if_txt), comp_types)));
                str elem_t = py_to_string(py_dict_get_default(elt_node, py_to_string("resolved_type"), "unknown"));
        ...
        if (!py_is_none(m_lc)) {
            ...
            dict<str, object> iter_node = _sh_parse_expr_lowered(py_to_string(iter_txt), ln_no, col + txt.find(iter_txt), name_types);
            str it_t = py_to_string(py_dict_get_default(iter_node, py_to_string("resolved_type"), "unknown"));
            str elem_t = "unknown";
        ...
        if (py_len(tuple_parts) >= 2) {
            ...
            list<str> elem_ts = [&]() -> list<str> {     list<str> __out;     for (auto e : elems) {         __out.append(py_to_string(py_dict_get_default(e, py_to_string("resolved_type"), "unknown")));     }     return __out; }();
    ...
    list<dict<str, object>> _sh_parse_stmt_block(list<::std::tuple<int64, str>>& body_lines, dict<str, str>& name_types, const str& scope_label) {
        /* インデントブロックを文単位で解析し、EAST 文リストを返す。 */
        auto __tuple_32 = _sh_merge_logical_lines(body_lines);
        body_lines = ::std::get<0>(__tuple_32);
        dict<int64, ::std::tuple<int64, int64>> merged_line_end = ::std::get<1>(__tuple_32);
        ...
        while (i < py_len(body_lines)) {
            auto __tuple_33 = body_lines[i];
            int64 ln_no = ::std::get<0>(__tuple_33);
            str ln_txt = ::std::get<1>(__tuple_33);
            ...
            if ((py_startswith(s, "if ")) && (py_endswith(s, ":"))) {
                ...
                auto __tuple_34 = _sh_collect_indented_block(body_lines, i + 1, indent);
                list<::std::tuple<int64, str>> then_block = ::std::get<0>(__tuple_34);
                int64 j = ::std::get<1>(__tuple_34);
                ...
                auto __tuple_35 = _sh_parse_if_tail(j, indent, body_lines, name_types, scope_label);
                list<dict<str, object>> else_stmt_list = ::std::get<0>(__tuple_35);
                j = ::std::get<1>(__tuple_35);
            ...
            if ((py_startswith(s, "for ")) && (py_endswith(s, ":"))) {
                ::std::optional<rc<pytra::std::re::Match>> m_for = pytra::std::re::match("^for\\s+(.+)\\s+in\\s+(.+):$", s, pytra::std::re::S);
                if (py_is_none(m_for))
                ...
                auto tgt_txt = pytra::std::re::strip_group(m_for, 1);
                auto iter_txt = pytra::std::re::strip_group(m_for, 2);
                ...
                auto __tuple_36 = _sh_collect_indented_block(body_lines, i + 1, indent);
                list<::std::tuple<int64, str>> body_block = ::std::get<0>(__tuple_36);
                int64 j = ::std::get<1>(__tuple_36);
                ...
                str t_ty = "unknown";
                str i_ty = py_to_string(py_dict_get_default(iter_expr, py_to_string("resolved_type"), "unknown"));
                ...
                if ((py_is_dict(target_expr)) && (py_dict_get(target_expr, py_to_string("kind")) == "Name")) {
                    str nm = py_to_string(py_dict_get_default(target_expr, py_to_string("id"), ""));
                    if (nm != "")
                        target_names.append(str(nm));
                } else {
                    if ((py_is_dict(target_expr)) && (py_dict_get(target_expr, py_to_string("kind")) == "Tuple")) {
                        object elem_nodes_obj = make_object(py_dict_get_default(target_expr, py_to_string("elements"), list<object>{}));
                        list<dict<str, object>> elem_nodes = (py_is_list(elem_nodes_obj) ? elem_nodes_obj : list<object>{});
                        for (dict<str, object> e : elem_nodes) {
                            if ((py_is_dict(e)) && (py_dict_get(e, py_to_string("kind")) == "Name")) {
                                str nm = py_to_string(py_dict_get_default(e, py_to_string("id"), ""));
                                if (nm != "")
                                    target_names.append(str(nm));
                            }
                        }
                ...
                if ((py_is_dict(target_expr)) && (py_dict_get(target_expr, py_to_string("kind")) == "Name") && (py_is_dict(iter_expr)) && (py_dict_get(iter_expr, py_to_string("kind")) == "Call") && (py_is_dict(py_dict_get(iter_expr, py_to_string("func")))) && (py_dict_get(py_dict_get_default(iter_expr, py_to_string("func"), dict<str, object>{}), "kind") == "Name") && (py_dict_get(py_dict_get_default(iter_expr, py_to_string("func"), dict<str, object>{}), "id") == "range")) {
                    list<object> rargs = py_dict_get_default(iter_expr, py_to_string("args"), list<object>{});
                    ...
                    str tgt = py_to_string(py_dict_get_default(target_expr, py_to_string("id"), ""));
                    if (tgt != "")
            ...
            if ((py_startswith(s, "with ")) && (py_endswith(s, ":"))) {
                ...
                name_types[py_to_string(as_name)] = py_to_string(py_dict_get_default(ctx_expr, py_to_string("resolved_type"), "unknown"));
                auto __tuple_37 = _sh_collect_indented_block(body_lines, i + 1, indent);
                list<::std::tuple<int64, str>> body_block = ::std::get<0>(__tuple_37);
                int64 j = ::std::get<1>(__tuple_37);
                if (py_len(body_block) == 0)
                ...
                dict<str, str> assign_stmt = dict<str, object>{{"kind", make_object("Assign")}, {"source_span", make_object(_sh_stmt_span(merged_line_end, ln_no, as_col, py_len(ln_txt)))}, {"target", make_object(dict<str, object>{{"kind", make_object("Name")}, {"source_span", make_object(_sh_span(ln_no, as_col, as_col + py_len(as_name)))}, {"resolved_type", make_object(py_to_string(py_dict_get_default(ctx_expr, py_to_string("resolved_type"), "unknown")))}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(as_name)}, {"id", make_object(as_name)}})}, {"value", make_object(ctx_expr)}, {"declare", make_object(true)}, {"declare_init", make_object(true)}, {"decl_type", make_object(py_to_string(py_dict_get_default(ctx_expr, py_to_string("resolved_type"), "unknown")))}};
            ...
            if ((py_startswith(s, "while ")) && (py_endswith(s, ":"))) {
                ...
                list<::std::tuple<int64, str>> body_block = ::std::get<0>(__tuple_38);
            ...
            if (s == "try:") {
                auto __tuple_39 = _sh_collect_indented_block(body_lines, i + 1, indent);
                list<::std::tuple<int64, str>> try_body = ::std::get<0>(__tuple_39);
                int64 j = ::std::get<1>(__tuple_39);
                ...
                while (j < py_len(body_lines)) {
                    auto __tuple_40 = body_lines[j];
                    int64 h_no = ::std::get<0>(__tuple_40);
                    str h_ln = ::std::get<1>(__tuple_40);
                    auto h_s = py_strip(h_ln);
                    int64 h_indent = py_len(h_ln) - py_len(py_lstrip(h_ln, " "));
                    if (h_indent != indent)
                        break;
                    ::std::optional<rc<pytra::std::re::Match>> m_exc_as = pytra::std::re::match("^except\\s+(.+?)\\s+as\\s+([A-Za-z_][A-Za-z0-9_]*)\\s*:\\s*$", h_s, pytra::std::re::S);
                    ::std::optional<rc<pytra::std::re::Match>> m_exc_plain = pytra::std::re::match("^except\\s+(.+?)\\s*:\\s*$", h_s, pytra::std::re::S);
                    if ((!py_is_none(m_exc_as)) || (!py_is_none(m_exc_plain))) {
                        object ex_type_txt;
                        ::std::optional<str> ex_name;
                        if (!py_is_none(m_exc_as)) {
                            ex_type_txt = make_object(pytra::std::re::strip_group(m_exc_as, 1));
                            ex_name = pytra::std::re::group(m_exc_as, 2);
                        } else {
                            ex_type_txt = make_object((!py_is_none(m_exc_plain) ? pytra::std::re::strip_group(m_exc_plain, 1) : "Exception"));
                            ex_name = ::std::nullopt;
                        }
                        auto ex_type_col = h_ln.find(ex_type_txt);
                        auto __tuple_41 = _sh_collect_indented_block(body_lines, j + 1, indent);
                        list<::std::tuple<int64, str>> h_body = ::std::get<0>(__tuple_41);
                        int64 k = ::std::get<1>(__tuple_41);
                        handlers.append(dict<str, object>(dict<str, object>{{"kind", make_object("ExceptHandler")}, {"type", make_object(_sh_parse_expr_lowered(py_to_string(ex_type_txt), h_no, ex_type_col, name_types))}, {"name", make_object(ex_name)}, {"body", make_object(_sh_parse_stmt_block(h_body, name_types, scope_label))}}));
                        j = k;
                        continue;
                    }
                    if (h_s == "finally:") {
                        auto __tuple_42 = _sh_collect_indented_block(body_lines, j + 1, indent);
                        list<::std::tuple<int64, str>> f_body = ::std::get<0>(__tuple_42);
                        int64 k = ::std::get<1>(__tuple_42);
            ...
            if (py_startswith(s, "raise ")) {
                ...
                if (!py_is_none(cause_split)) {
                    auto __tuple_43 = *(cause_split);
                    str exc_txt = ::std::get<0>(__tuple_43);
                    str cause_txt = ::std::get<1>(__tuple_43);
                    expr_txt = exc_txt;
            ...
            ::std::optional<rc<pytra::std::re::Match>> m_ann_decl = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_]*(?:\\.[A-Za-z_][A-Za-z0-9_]*)?)\\s*:\\s*(.+)$", s);
            if ((!py_is_none(m_ann_decl)) && (!py_contains(s, "="))) {
                auto target_txt = pytra::std::re::group(m_ann_decl, 1);
                str ann = _sh_ann_to_type(pytra::std::re::group(m_ann_decl, 2));
                ...
                if ((py_is_dict(target_expr)) && (py_dict_get(target_expr, py_to_string("kind")) == "Name"))
                    name_types[py_to_string(py_to_string(py_dict_get_default(target_expr, py_to_string("id"), "")))] = ann;
            ...
            ::std::optional<rc<pytra::std::re::Match>> m_ann = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_]*(?:\\.[A-Za-z_][A-Za-z0-9_]*)?)\\s*:\\s*([^=]+?)\\s*=\\s*(.+)$", s);
            if (!py_is_none(m_ann)) {
                auto target_txt = pytra::std::re::group(m_ann, 1);
                str ann = _sh_ann_to_type(pytra::std::re::group(m_ann, 2));
                auto expr_txt = pytra::std::re::strip_group(m_ann, 3);
                auto expr_col = ln_txt.find(expr_txt);
            ...
            ::std::optional<rc<pytra::std::re::Match>> m_aug = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_]*(?:\\.[A-Za-z_][A-Za-z0-9_]*)?)\\s*(\\+=|-=|\\*=|/=|//=|%=|&=|\\|=|\\^=|<<=|>>=)\\s*(.+)$", s);
            if (!py_is_none(m_aug)) {
                auto target_txt = pytra::std::re::group(m_aug, 1);
                dict<str, str> op_map = dict<str, str>{{"+=", "Add"}, {"-=", "Sub"}, {"*=", "Mult"}, {"/=", "Div"}, {"//=", "FloorDiv"}, {"%=", "Mod"}, {"&=", "BitAnd"}, {"|=", "BitOr"}, {"^=", "BitXor"}, {"<<=", "LShift"}, {">>=", "RShift"}};
                auto expr_txt = pytra::std::re::strip_group(m_aug, 3);
                auto expr_col = ln_txt.find(expr_txt);
                auto target_col = ln_txt.find(target_txt);
                dict<str, object> target_expr = _sh_parse_expr_lowered(target_txt, ln_no, target_col, name_types);
                dict<str, object> val_expr = _sh_parse_expr_lowered(expr_txt, ln_no, expr_col, name_types);
                ...
                if ((py_is_dict(target_expr)) && (py_dict_get(target_expr, py_to_string("kind")) == "Name"))
                    target_ty = py_dict_get_default(name_types, py_to_string(py_to_string(py_dict_get_default(target_expr, py_to_string("id"), ""))), "unknown");
                ::std::optional<str> decl_type = ::std::nullopt;
                if (target_ty != "unknown")
                    decl_type = target_ty;
                pending_blank_count = _sh_push_stmt_with_trivia(stmts, pending_leading_trivia, pending_blank_count, dict<str, object>{{"kind", make_object("AugAssign")}, {"source_span", make_object(_sh_stmt_span(merged_line_end, ln_no, target_col, py_len(ln_txt)))}, {"target", make_object(target_expr)}, {"op", make_object(py_dict_get(op_map, py_to_string(pytra::std::re::group(m_aug, 2))))}, {"value", make_object(val_expr)}, {"declare", make_object(false)}, {"decl_type", make_object(decl_type)}});
                i++;
                continue;
            }
            ...
            if (!py_is_none(m_tasg)) {
                ...
                auto expr_txt = pytra::std::re::strip_group(m_tasg, 3);
                auto expr_col = ln_txt.find(expr_txt);
                ...
                if ((py_is_dict(rhs)) && (py_dict_get(rhs, py_to_string("kind")) == "Tuple") && (py_len(py_dict_get_default(rhs, py_to_string("elements"), list<object>{})) == 2) && (py_is_dict(py_at(py_dict_get(rhs, py_to_string("elements")), py_to_int64(0)))) && (py_is_dict(py_at(py_dict_get(rhs, py_to_string("elements")), py_to_int64(1)))) && (py_dict_get(py_at(py_dict_get(rhs, py_to_string("elements")), py_to_int64(0)), "kind") == "Name") && (py_dict_get(py_at(py_dict_get(rhs, py_to_string("elements")), py_to_int64(1)), "kind") == "Name") && (py_to_string(py_dict_get_default(py_at(py_dict_get(rhs, py_to_string("elements")), py_to_int64(0)), "id", "")) == n2) && (py_to_string(py_dict_get_default(py_at(py_dict_get(rhs, py_to_string("elements")), py_to_int64(1)), "id", "")) == n1)) {
            ...
            if (!py_is_none(asg_split)) {
                auto __tuple_44 = *(asg_split);
                str target_txt = ::std::get<0>(__tuple_44);
                str expr_txt = ::std::get<1>(__tuple_44);
                auto expr_col = ln_txt.find(expr_txt);
                auto target_col = ln_txt.find(target_txt);
                dict<str, object> target_expr = _sh_parse_expr_lowered(target_txt, ln_no, target_col, name_types);
                dict<str, object> val_expr = _sh_parse_expr_lowered(expr_txt, ln_no, expr_col, name_types);
                ::std::optional<str> decl_type = py_dict_get_default(val_expr, py_to_string("resolved_type"), "unknown");
                if ((py_is_dict(target_expr)) && (py_dict_get(target_expr, py_to_string("kind")) == "Name")) {
                    str nm = py_to_string(py_dict_get_default(target_expr, py_to_string("id"), ""));
                    if (nm != "")
    ...
    dict<str, object> convert_source_to_east_self_hosted(const str& source, const str& filename) {
        ...
        for (auto __it_45 : py_enumerate(lines)) {
            auto ln_no = ::std::get<0>(__it_45);
            auto ln = ::std::get<1>(__it_45);
            auto s = py_strip(ln);
            if (s == "")
                continue;
            ...
            if ((!py_is_none(cur_cls)) && (indent <= cur_cls_indent) && (!(py_startswith(s, "#"))))
                cur_cls = ::std::nullopt;
            ::std::optional<rc<pytra::std::re::Match>> m_cls = pytra::std::re::match("^class\\s+([A-Za-z_][A-Za-z0-9_]*)(?:\\(([A-Za-z_][A-Za-z0-9_]*)\\))?\\s*:\\s*$", ln);
            if (!py_is_none(m_cls)) {
                str cur_cls_name = pytra::std::re::group(m_cls, 1);
                cur_cls = cur_cls_name;
                cur_cls_indent = indent;
                class_base[py_to_string(cur_cls_name)] = pytra::std::re::group(m_cls, 2);
        ...
        auto __tuple_46 = _sh_merge_logical_lines(top_lines);
        list<::std::tuple<int64, str>> top_merged_lines = ::std::get<0>(__tuple_46);
        dict<int64, ::std::tuple<int64, int64>> top_merged_end = ::std::get<1>(__tuple_46);
        dict<int64, str> top_merged_map = dict<int64, str>{};
        for (auto __it_47 : top_merged_lines) {
            auto top_ln_no = ::std::get<0>(__it_47);
            auto top_txt = ::std::get<1>(__it_47);
        ...
        while (i <= py_len(lines)) {
            ...
            ::std::optional<rc<pytra::std::re::Match>> m_main = pytra::std::re::match("^if\\s+__name__\\s*==\\s*[\\\"']__main__[\\\"']\\s*:\\s*$", ln);
            if (!py_is_none(m_main)) {
            ...
            if (!py_is_none(sig)) {
                ...
                object arg_defaults_raw_obj = make_object(py_dict_get(sig, "arg_defaults"));
                ...
                auto __tuple_48 = _sh_extract_leading_docstring(stmts);
                ::std::optional<str> docstring = ::std::get<0>(__tuple_48);
                stmts = ::std::get<1>(__tuple_48);
                dict<str, object> arg_defaults = dict<str, object>{};
                dict<str, int64> arg_index_map = dict<str, int64>{};
                for (auto __it_49 : py_enumerate(arg_order)) {
                    auto arg_pos = ::std::get<0>(__it_49);
                    auto arg_name = ::std::get<1>(__it_49);
            ...
            if (!py_is_none(m_import)) {
                ...
                for (str part : raw_parts) {
                    ::std::optional<rc<pytra::std::re::Match>> m_alias = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_\\.]*)(?:\\s+as\\s+([A-Za-z_][A-Za-z0-9_]*))?$", part);
                    if (py_is_none(m_alias))
                    ...
                    auto mod_name = pytra::std::re::group(m_alias, 1);
                    auto as_name = pytra::std::re::group(m_alias, 2);
                    auto bind_name = ((py_is_str(as_name)) && (as_name != "") ? as_name : py_at(mod_name.split("."), py_to_int64(0)));
                    _sh_append_import_binding(import_bindings, import_binding_names, mod_name, "", bind_name, "module", filename, i);
                    aliases.append(dict<str, ::std::optional<str>>(dict<str, object>{{"name", make_object(mod_name)}, {"asname", make_object(as_name)}}));
                }
            ...
            if (!py_is_none(m_import_from)) {
                auto mod_name = pytra::std::re::strip_group(m_import_from, 1);
                ...
                for (str part : raw_parts) {
                    ...
                    auto sym_name = pytra::std::re::group(m_alias, 1);
                    auto as_name = pytra::std::re::group(m_alias, 2);
                    auto bind_name = ((py_is_str(as_name)) && (as_name != "") ? as_name : sym_name);
                    _sh_append_import_binding(import_bindings, import_binding_names, mod_name, sym_name, bind_name, "symbol", filename, i);
                    aliases.append(dict<str, ::std::optional<str>>(dict<str, object>{{"name", make_object(sym_name)}, {"asname", make_object(as_name)}}));
                }
            ...
            ::std::optional<rc<pytra::std::re::Match>> m_cls = pytra::std::re::match("^class\\s+([A-Za-z_][A-Za-z0-9_]*)(?:\\(([A-Za-z_][A-Za-z0-9_]*)\\))?\\s*:\\s*$", ln);
            if (!py_is_none(m_cls)) {
                auto cls_name = pytra::std::re::group(m_cls, 1);
                auto base = pytra::std::re::group(m_cls, 2);
                bool is_enum_base = py_contains(set<str>{"Enum", "IntEnum", "IntFlag"}, base);
                ...
                if (py_len(block) == 0)
                    throw _make_east_build_error("unsupported_syntax", "self_hosted parser requires non-empty class body '" + py_to_string(cls_name) + "'", _sh_span(i, 0, py_len(ln)), "Add field or method definitions.");
                auto __tuple_50 = _sh_merge_logical_lines(block);
                list<::std::tuple<int64, str>> class_block = ::std::get<0>(__tuple_50);
                dict<int64, ::std::tuple<int64, int64>> _class_line_end = ::std::get<1>(__tuple_50);
                ...
                while (k < py_len(class_block)) {
                    auto __tuple_51 = class_block[k];
                    auto ln_no_raw = py_at(__tuple_51, 0);
                    auto ln_txt_raw = py_at(__tuple_51, 1);
                    ...
                    if ((bind == cls_indent + 4) && ((py_startswith(s2, "\"\"\"")) || (py_startswith(s2, "'''")))) {
                        ...
                        k++;
                        while (k < py_len(class_block)) {
                            auto __tuple_52 = class_block[k];
                            auto _doc_no = py_at(__tuple_52, 0);
                            auto doc_txt = py_at(__tuple_52, 1);
                    ...
                    if (bind == cls_indent + 4) {
                        ...
                        ::std::optional<rc<pytra::std::re::Match>> m_field = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_]*)\\s*:\\s*([^=]+?)(?:\\s*=\\s*(.+))?$", s2);
                        if (!py_is_none(m_field)) {
                            auto fname = pytra::std::re::group(m_field, 1);
                            str fty = _sh_ann_to_type(pytra::std::re::group(m_field, 2));
                            field_types[py_to_string(fname)] = fty;
                            ::std::optional<dict<str, object>> val_node = ::std::nullopt;
                            if (pytra::std::re::group(m_field, 3) != "") {
                                auto fexpr_txt = pytra::std::re::strip_group(m_field, 3);
                        ...
                        if (is_enum_base) {
                            ::std::optional<rc<pytra::std::re::Match>> m_enum_assign = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_]*)\\s*=\\s*(.+)$", s2);
                            if (!py_is_none(m_enum_assign)) {
                                auto fname = pytra::std::re::group(m_enum_assign, 1);
                                auto fexpr_txt = pytra::std::re::strip_group(m_enum_assign, 2);
                                ...
                                class_body.append(dict<str, object>(dict<str, object>{{"kind", make_object("Assign")}, {"source_span", make_object(_sh_span(ln_no, name_col, py_len(ln_txt)))}, {"target", make_object(dict<str, object>{{"kind", make_object("Name")}, {"source_span", make_object(_sh_span(ln_no, name_col, name_col + py_len(fname)))}, {"resolved_type", make_object(py_to_string(py_dict_get_default(val_node, py_to_string("resolved_type"), "unknown")))}, {"borrow_kind", make_object("value")}, {"casts", make_object(list<object>{})}, {"repr", make_object(fname)}, {"id", make_object(fname)}})}, {"value", make_object(val_node)}, {"declare", make_object(true)}, {"declare_init", make_object(true)}, {"decl_type", make_object(py_to_string(py_dict_get_default(val_node, py_to_string("resolved_type"), "unknown")))}}));
                                k++;
                                continue;
                            }
                        }
                        ...
                        if (!py_is_none(sig)) {
                            ...
                            object marg_defaults_raw_obj = make_object(py_dict_get(sig, "arg_defaults"));
                            ...
                            if (py_len(method_block) == 0)
                                throw _make_east_build_error("unsupported_syntax", "self_hosted parser requires non-empty method body '" + py_to_string(cls_name) + "." + mname + "'", _sh_span(ln_no, 0, py_len(ln_txt)), "Add method statements.");
                            ...
                            list<dict<str, object>> stmts = _sh_parse_stmt_block(method_block, local_types, py_to_string(cls_name) + "." + mname);
                            auto __tuple_53 = _sh_extract_leading_docstring(stmts);
                            ::std::optional<str> docstring = ::std::get<0>(__tuple_53);
                            stmts = ::std::get<1>(__tuple_53);
                            ...
                            if (mname == "__init__") {
                                for (dict<str, object> st : stmts) {
                                    if (py_dict_get(st, py_to_string("kind")) == "Assign") {
                                        auto tgt = py_dict_get(st, py_to_string("target"));
                                        object tgt_value = object{};
                                        if (py_is_dict(tgt))
                                            tgt_value = make_object(py_dict_get(tgt, "value"));
                                        ::std::optional<dict<str, object>> tgt_value_dict = ::std::nullopt;
                                        if (py_is_dict(tgt_value))
                                            tgt_value_dict = tgt_value;
                                        if ((py_is_dict(tgt)) && (py_dict_get(tgt, "kind") == "Attribute") && (!py_is_none(tgt_value_dict)) && (py_dict_get(tgt_value_dict, "kind") == "Name") && (py_dict_get(tgt_value_dict, "id") == "self")) {
                                            str fname = py_to_string(py_dict_get_default(tgt, "attr", ""));
                                            if (fname != "") {
                                                auto st_value = py_dict_get(st, py_to_string("value"));
                                                object st_value_rt = object{};
                                                if (py_is_dict(st_value))
                                                    st_value_rt = make_object(py_dict_get(st_value, "resolved_type"));
                                                object t_val = make_object(py_dict_get(st, py_to_string("decl_type")));
                                    ...
                                    if (py_dict_get(st, py_to_string("kind")) == "AnnAssign") {
                                        auto tgt = py_dict_get(st, py_to_string("target"));
                                        object tgt_value = object{};
                                        if (py_is_dict(tgt))
                                            tgt_value = make_object(py_dict_get(tgt, "value"));
                                        ...
                                        if ((py_is_dict(tgt)) && (py_dict_get(tgt, "kind") == "Attribute") && (!py_is_none(tgt_value_dict)) && (py_dict_get(tgt_value_dict, "kind") == "Name") && (py_dict_get(tgt_value_dict, "id") == "self")) {
                                            str fname = py_to_string(py_dict_get_default(tgt, "attr", ""));
                                            auto ann = py_dict_get(st, py_to_string("annotation"));
                ...
                bool has_del = py_any([&]() -> list<bool> {     list<bool> __out;     for (auto st : class_body) {         __out.append((py_is_dict(st)) && (py_dict_get(st, py_to_string("kind")) == "FunctionDef") && (py_dict_get(st, py_to_string("name")) == "__del__"));     }     return __out; }());
                ...
                if (storage_hint_override != "") {
                    ...
                    if (py_contains(set<str>{"Enum", "IntEnum", "IntFlag"}, base)) {
                        cls_item[py_to_string("class_storage_hint")] = make_object("value");
                    } else {
                        if ((py_len(instance_field_names) == 0) && (!(has_del)) && (!(py_is_str(base))))
                            cls_item[py_to_string("class_storage_hint")] = make_object("value");
                        else
            ...
            ::std::optional<rc<pytra::std::re::Match>> m_ann_top = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_]*)\\s*:\\s*([^=]+?)\\s*=\\s*(.+)$", s, pytra::std::re::S);
            if (!py_is_none(m_ann_top)) {
                auto name = pytra::std::re::group(m_ann_top, 1);
                str ann = _sh_ann_to_type(pytra::std::re::group(m_ann_top, 2));
                auto expr_txt = pytra::std::re::strip_group(m_ann_top, 3);
            ...
            ::std::optional<rc<pytra::std::re::Match>> asg_top = pytra::std::re::match("^([A-Za-z_][A-Za-z0-9_]*)\\s*=\\s*(.+)$", s, pytra::std::re::S);
            if (!py_is_none(asg_top)) {
                auto name = pytra::std::re::group(asg_top, 1);
                auto expr_txt = pytra::std::re::strip_group(asg_top, 2);
                auto expr_col = ln.find(expr_txt);
                if (expr_col < 0)
                    expr_col = 0;
                dict<str, object> val_node = _sh_parse_expr_lowered(expr_txt, i, expr_col, dict<str, object>{});
                str decl_type = py_to_string(py_dict_get_default(val_node, py_to_string("resolved_type"), "unknown"));
        ...
        for (dict<str, object> item : body_items) {
            if ((py_dict_get(item, py_to_string("kind")) == "FunctionDef") && (py_dict_get(item, py_to_string("name")) == "main")) {
        ...
        for (dict<str, object> binding : import_bindings) {
            auto module_id_obj = py_dict_get(binding, py_to_string("module_id"));
            auto local_name_obj = py_dict_get(binding, py_to_string("local_name"));
            auto export_name_obj = py_dict_get(binding, py_to_string("export_name"));
            auto binding_kind_obj = py_dict_get(binding, py_to_string("binding_kind"));
            str module_id = "";
