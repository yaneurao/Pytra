...
public final class gif {
    ...
    public static void save_gif(String path, long width, long height, java.util.ArrayList<java.util.ArrayList<Long>> frames, java.util.ArrayList<Long> palette, long delay_cs, long loop) {
        ...
        out.addAll(PyRuntime.__pytra_int_to_bytes(width, 2L, "little"));
        out.addAll(PyRuntime.__pytra_int_to_bytes(height, 2L, "little"));
        out.add(247L);
        out.add(0L);
        out.add(0L);
        out.addAll(palette);
        ...
        out.addAll(PyRuntime.__pytra_int_to_bytes(loop, 2L, "little"));
        out.add(0L);
        ...
        for (long __iter_i_3 = 0L; __iter_i_3 < ((long)(__iter_2.size())); __iter_i_3 += 1L) {
            ...
            out.addAll(PyRuntime.__pytra_int_to_bytes(delay_cs, 2L, "little"));
            out.addAll(new java.util.ArrayList<Long>(java.util.Arrays.asList(0L, 0L)));
            out.add(44L);
            out.addAll(PyRuntime.__pytra_int_to_bytes(0L, 2L, "little"));
            out.addAll(PyRuntime.__pytra_int_to_bytes(0L, 2L, "little"));
            out.addAll(PyRuntime.__pytra_int_to_bytes(width, 2L, "little"));
            out.addAll(PyRuntime.__pytra_int_to_bytes(height, 2L, "little"));
            out.add(0L);
