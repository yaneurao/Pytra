...
from hooks.kotlin.emitter.kotlin_native_emitter import transpile_to_kotlin_native
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        help="Kotlin backend mode: native (default) or sidecar compatibility",
    )
    ...
    kotlin_backend = _arg_get_str(args, "kotlin_backend")
    if kotlin_backend == "":
        kotlin_backend = "native"
    if east_stage == "2":
