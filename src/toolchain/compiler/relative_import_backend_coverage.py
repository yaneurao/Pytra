...
RELATIVE_IMPORT_BACKEND_COVERAGE_V1: Final[list[dict[str, str]]] = [
    ...
    },
    {
        ...
        "contract_state": "transpile_smoke_locked",
        "evidence_lane": "native_emitter_function_body_transpile",
        "notes": "Representative relative-import smoke is now locked through direct native-emitter function-body transpile checks; wildcard import remains fail-closed while Ruby stays in the residual long-tail rollout.",
    },
    {
        "backend": "ruby",
