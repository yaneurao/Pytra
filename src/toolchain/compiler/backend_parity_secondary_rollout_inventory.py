...
SECONDARY_ROLLOUT_BUNDLES_V1: Final[tuple[SecondaryRolloutBundle, ...]] = (
    ...
    },
    {
        ...
        "target_evidence": "transpile_smoke",
        "notes": "The active residual bundle is now scala/swift/nim; Scala/Swift still need for_range+range, while Nim swaps those for virtual_dispatch.",
    },
)
...
SECONDARY_ROLLOUT_HANDOFF_V1: Final[dict[str, object]] = {
    ...
    "completed_backends": ("go", "java", "kt"),
    "next_backend": "scala",
    "remaining_backends": ("swift", "nim"),
    "bundle_order": tuple(bundle["bundle_id"] for bundle in SECONDARY_ROLLOUT_BUNDLES_V1),
    "next_bundle": "scala_swift_nim_bundle",
