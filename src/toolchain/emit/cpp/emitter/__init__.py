...
from toolchain.emit.cpp.emitter.cpp_emitter import (
    CppEmitter,
    emit_cpp_from_east,
)
from toolchain.emit.cpp.emitter.profile_loader import load_cpp_profile
...
def transpile_to_cpp(
    ...
    from toolchain.emit.cpp import cli as cpp_cli
