#!/usr/bin/env python3
"""EAST3 human renderer helpers (C++-style pseudo view)."""

from __future__ import annotations

from pytra.std.typing import Any

from .render_human_east2_cpp import (
    _cpp_type_name,
    _dump_json,
    _expr_repr,
    _fmt_span,
...
def render_east3_human_cpp(out_doc: dict[str, Any]) -> str:
    """Render EAST doc into EAST3-oriented human-readable C++ pseudo code."""
    lines: list[str] = []
...
def render_east_human_cpp(out_doc: dict[str, Any]) -> str:
    """Compatibility alias for EAST3 human renderer."""
