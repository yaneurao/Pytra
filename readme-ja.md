...
⚠ C++ runtime の `py_to_int64` / `py_to<int64>` は互換重視で「変換不能時に 0 を返す」挙動です。厳密検証が必要な箇所は `obj_to_int64_or_raise` を利用してください。
...
|-|-|-:|-:|-:|-:|-:|-:|-:|-:|-:|-:|
|01 |マンデルブロ集合（PNG）|18.647|0.188|0.771|0.383|0.768|0.806|0.753|0.756|0.760|0.756|
|02 |球の簡易レイトレーサ（PNG）|6.890|0.265|0.156|0.918|0.277|0.288|0.256|0.260|0.289|0.258|
|03 |ジュリア集合（PNG）|22.770|0.812|0.769|1.468|1.210|1.127|1.126|1.136|1.125|1.151|
|04 |オービットトラップ Julia（PNG）|11.950|0.208|0.339|0.416|0.473|0.504|0.466|0.471|0.482|0.469|
|05 |マンデルブロズーム（GIF）|14.538|0.663|0.533|1.710|0.703|0.680|0.691|0.689|0.695|0.687|
|06 |ジュリア集合パラメータ掃引（GIF）|9.627|0.286|0.383|0.329|0.626|0.619|0.622|0.621|0.624|0.629|
|07 |ライフゲーム（GIF）|5.134|1.277|0.727|1.530|1.364|1.311|1.191|1.248|1.290|1.267|
|08 |ラングトンのアリ（GIF）|5.220|1.718|1.746|2.213|2.031|1.997|1.912|2.011|1.886|2.019|
|09 |炎シミュレーション（GIF）|10.895|2.047|7.330|6.566|2.374|2.290|2.368|2.265|2.306|2.358|
|10 |プラズマエフェクト（GIF）|6.194|1.251|0.525|2.646|1.444|1.886|1.397|1.414|1.444|1.319|
|11 |リサージュ粒子（GIF）|3.582|1.336|0.338|0.714|1.425|1.406|1.389|1.365|1.371|1.413|
|12 |ソート可視化（GIF）|3.864|1.304|0.335|0.680|1.341|1.343|1.309|1.348|1.328|1.306|
|13 |迷路生成ステップ（GIF）|3.402|1.039|0.274|1.037|1.038|1.035|0.985|1.025|0.997|0.987|
|14 |簡易レイマーチング（GIF）|2.670|0.379|0.147|0.606|0.489|0.573|0.490|0.513|0.503|0.492|
|15 |波干渉ループ（GIF）|2.631|0.557|0.236|1.196|0.616|0.794|0.609|0.614|0.629|0.612|
|16 |ガラス彫刻のカオス回転（GIF）|6.847|0.892|0.226|1.220|0.650|0.822|0.638|0.643|0.667|0.643|
|17 |モンテカルロ法で円周率近似（PNG）|0.293|0.002|0.002|0.010|0.046|0.045|0.047|0.048|0.047|0.048|
|18 |ミニ言語インタプリタ|2.037|0.326|1.117|0.735|0.446|0.446|0.405|0.417|0.423|0.417|
...
- `>1.5x` の乖離は Rust遅延側が `01/04/09/18`、C++遅延側が `07/10/11/12/13/14/15/16` に残っています。次アクションは Rust 側 PNG/インタプリタ hot path 削減と C++ 側 GIF encode 経路の flatten です。
