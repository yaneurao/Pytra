<a href="../../../docs-ja/todo/archive/20260222.md">
...
1. Marked completion of the `docs/todo/index.md` task: split `render_expr` Call branches by feature and migrate to `CodeEmitter` helpers.
...
1. Marked completion of the corresponding `docs/todo/index.md` reduction task.
2. Confirmed evidence.
...
1. Marked completion of the cleanup task in `docs/todo/index.md`.
...
1. Marked completion of the corresponding `docs/todo/index.md` task.
...
1. Marked completion of `Implement hook injection (EmitterHooks)` in `docs/todo/index.md`.
...
2. Added operational path for `docs/todo/archive/`.
