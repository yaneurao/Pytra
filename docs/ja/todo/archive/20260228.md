...
6. [x] [ID: P0-LUA-BACKEND-01-S3-01] `tools/check/check_py2lua_transpile.py` と `test_py2lua_smoke.py`、`runtime_parity_check --targets lua` 導線を追加し回帰を固定する。
