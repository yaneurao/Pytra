...
1. [ ] [ID: P0-CPP-PYRUNTIME-OBJECT-DICTDEFAULT-REMAIN-01] 残存 `dict<str, object>` default lane を退役または最小化する。
...
2. [ ] [ID: P0-CPP-PYRUNTIME-OBJECT-KEY-01] `dict<str, V>` への `object` key compat を退役する。
...
3. [ ] [ID: P0-CPP-PYRUNTIME-OPTIONAL-DICTGET-01] `optional<dict<...>>` `py_dict_get` compat を退役する。
...
4. [ ] [ID: P0-CPP-PYRUNTIME-DICT-STR-NODE-FINAL-01] 残存 `dict_get_node(dict<str, str>)` を最終整理する。
