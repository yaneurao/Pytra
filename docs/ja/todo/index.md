...
- 進捗メモ: [ID: P1-IR-CORE-DECOMPOSITION-01-S3-01] `core_expr_primary.py` の `_parse_primary` を mixin 化し、`core.py` から primary wrapper を除去して postfix source-contract の境界を `def _make_bin` 基準へ統一した。
