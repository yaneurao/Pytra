...
- 進捗メモ: 2026-03-06 [ID: `P0-RUNTIME-SYMBOL-INDEX-01-S1-01` / `-S1-02` / `-S2-01` / `-S2-02` / `-S2-03` / `-S3-01` / `-S3-02` / `-S3-03`] 直書き棚卸し・schema 固定・generator 追加・stale index guard・EAST3 `BuiltinCall` / import 解決済み symbol への `runtime_module_id/runtime_symbol` 付与・`signature_registry` の path 推定責務不在の guard 追加まで実装した。
