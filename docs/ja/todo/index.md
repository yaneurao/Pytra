...
- 進捗メモ: `S1-02` まで完了。header bulk を `object-only compat` 4 件と `Any/object boundary fallback` 5 件に分離し、emitter/generated/sample の typed-lane residual 7 bucket を禁止側 contract として固定。
