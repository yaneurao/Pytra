...
- 進捗メモ: [ID: P1-IR-CORE-DECOMPOSITION-01-S2-02] `test_east_core_source_contract_expr_suffix.py` と `test_east_core_source_contract_call_metadata.py` を追加し、source-contract guard 20 本を `test_east_core.py` から切り出した。
