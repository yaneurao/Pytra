...
`P0-CPP-PYRUNTIME-EXT-01` 進捗メモ: 2026-03-06 第一波を完了し、第二波は `py_reversed` / `py_enumerate` の object 経路本体を `iter_ops.gen.*` へ移管済み。残件は typed adapter の追加整理と `py_contains` の正本化。
