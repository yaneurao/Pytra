...
1. [ ] [ID: P0-FIX161-TSJS-S1] 未実行 3 件を `runtime_parity_check_fast.py --targets js,ts --case-root fixture` で確定し、fail なら分類へ追加する
2. [ ] [ID: P0-FIX161-TSJS-S2] mutation methods / reversed / trait / typed varargs / bytearray の fail を解消し、JS と TS の fixture parity 161/161 PASS を確認する
