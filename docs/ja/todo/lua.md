...
最終更新: 2026-04-01（P1-LUA-EMITTER-S6 完了、P2-LUA-LINT-S1 完了、fixture/sample parity 継続中）
...
5. [ ] [ID: P1-LUA-EMITTER-S5] fixture + sample の Lua run parity を通す（`lua5.4`）— 2026-04-01 時点で fixture `119/137 pass`、sample `1/18 pass`。fixture 残差は exception、dict/set wrapper、`isinstance_narrowing`、repr 系。sample 残差は画像 artifact、loop/continue、未実装 helper
