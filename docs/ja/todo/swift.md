...
1. [ ] [ID: P0-FIX161-SWIFT-S1] 未実行 3 件を `runtime_parity_check_fast.py --targets swift --case-root fixture` で確定し、fail なら分類へ追加する
2. [ ] [ID: P0-FIX161-SWIFT-S2] reversed / trait / typed varargs / union narrowing の fail を解消し、Swift fixture parity 161/161 PASS を確認する
