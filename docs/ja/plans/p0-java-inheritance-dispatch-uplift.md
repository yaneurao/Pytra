<a href="../../en/plans/p0-java-inheritance-dispatch-uplift.md">
...
- `PYTHONPATH=src python3 tools/check/runtime_parity_check.py inheritance_virtual_dispatch_multilang --targets java`
...
- 2026-03-01: `PYTHONPATH=src python3 -m unittest discover -s test/unit -p 'test_py2java_smoke.py' -v`（23 tests, pass）と `PYTHONPATH=src python3 tools/check/runtime_parity_check.py inheritance_virtual_dispatch_multilang --targets java --ignore-unstable-stdout`（1/1 pass）を確認した。
