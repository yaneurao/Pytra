...
- [ ] [ID: P1-NES3-NOT-IMPLEMENTED-ERROR-CPP-01-S1-01] current compile failure と desired C++ contract を focused regression / plan / TODO に固定する。
- [ ] [ID: P1-NES3-NOT-IMPLEMENTED-ERROR-CPP-01-S2-01] `NotImplementedError` の lowering / runtime mapping を追加し、未定義生シンボル emission を止める。
- [ ] [ID: P1-NES3-NOT-IMPLEMENTED-ERROR-CPP-01-S3-01] minimal repro と shared 影響 lane の compile smoke / docs を同期する。
