<a href="../../en/plans/p0-east3-optimizer-rollout.md">
...
- 2026-02-27: `P0-EAST3-OPT-01-S3-03` として `spec-east3-optimizer`（ja/en）を実装同期し、pass 実装状況表と fail-closed 条件を更新。`--dump-east3-opt-trace`、`--east3-opt-pass`、`runtime_parity_check --east3-opt-level` を使った運用手順を追記した。
...
- [x] [ID: P0-EAST3-OPT-01-S3-03] 実装差分を `spec-east3-optimizer` と同期し、運用手順（トレース確認/切り分け）を文書化する。
