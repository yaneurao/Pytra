...
- 現行 contract / manifest / build profile は、C# `pathlib` のように `generated compare_artifact + native handwritten canonical` を明示的に許容している。`json` は live-generated へ切り替わったが、`pathlib` はなお `src/runtime/cs/native/std/pathlib.cs` が canonical lane として残っている。
