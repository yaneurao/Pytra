<a href="../../../en/plans/archive/20260223-tg-p0-boxing.md">
...
- 2026-02-23: `P0-BOX-04` を完了。`tools/unittest/test_js_ts_runtime_dispatch.py` を追加し、JS/TS 側の minify 耐性 dispatch と hook 経路を検証した。既存の C++ runtime boxing / py2cpp codegen / py2js & py2ts smoke と合わせてクロスターゲット回帰を通過確認した。
