<a href="../../../en/plans/archive/p0-east1-build-compat-removal.md">
...
- 2026-02-24: [ID: `P0-EAST1-BUILD-01-S1`] `src/pytra/compiler/east_parts/east1_build.py` を追加し、`.py/.json -> EAST1` build（`build_east1_document`）と import graph 入口（`analyze_import_graph` / `build_module_east_map`）API を定義。`tools/unittest/test_east1_build.py` を新設して stage=1 契約を固定した。
