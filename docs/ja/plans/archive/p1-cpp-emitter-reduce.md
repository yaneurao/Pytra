<a href="../../../en/plans/archive/p1-cpp-emitter-reduce.md">
...
- `python3 tools/unittest/test_code_emitter.py`、
  `python3 tools/unittest/test_py2cpp_smoke.py`（既存ケース）、
  `python3 tools/check/check_py2cpp_transpile.py` が pass。
- `tools/run/run_local_ci.py` で C++ 変換関連ジョブの既存基線回帰なし。
