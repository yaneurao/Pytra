<a href="../../../en/plans/archive/p0-py2cpp-responsibility-split.md">
...
- 2026-02-27: `P0-PY2CPP-SPLIT-01-S7` 完了。`src/hooks/cpp/runtime_emit/__init__.py` で `_join_runtime_path` 等の互換エイリアスを追加し、`src/py2cpp.py` import 断絶を解消。`python3 tools/check/check_py2cpp_boundary.py` / `python3 tools/check/check_py2cpp_transpile.py` / `python3 -m unittest discover -s test/unit -p 'test_py2cpp_smoke.py'` を実行し、責務回帰ガードを固定。
