<a href="../../../en/plans/archive/20260312-p1-import-graph-frontend-decomposition.md">
...
- `PYTHONPATH=src python3 -m unittest discover -s tools/unittest/tooling -p 'test_relative_import_normalization_source_contract.py'`
