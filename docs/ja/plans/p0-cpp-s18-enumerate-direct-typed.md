<a href="../../en/plans/p0-cpp-s18-enumerate-direct-typed.md">
...
- 2026-03-01: `PYTHONPATH=src python3 -m unittest discover -s test/unit -p 'test_py2cpp_codegen_issues.py' -v`（80件）と `python3 tools/check/check_py2cpp_transpile.py`（`checked=134 ok=134 fail=0 skipped=6`）で非退行を確認した。
