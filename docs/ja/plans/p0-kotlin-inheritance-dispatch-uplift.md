<a href="../../en/plans/p0-kotlin-inheritance-dispatch-uplift.md">
...
- `PYTHONPATH=src python3 tools/check/runtime_parity_check.py inheritance_virtual_dispatch_multilang --targets kotlin`
