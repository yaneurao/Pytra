...
- 2026-03-08 snapshot では Wave 1 は `js/ts` が green、`rs/cs` が `toolchain_missing`、Wave 2/3 は `go/java/scala/lua` が `target_smoke_fail`、`kotlin/swift/ruby/php/nim` が `transpile_fail` を primary failure とする。
