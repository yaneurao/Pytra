...
- 2026-03-08 snapshot では Wave 1 は `js/ts` が green、`rs/cs` が `toolchain_missing`、Wave 2 も `go/java/kotlin/swift/scala` が sample parity 18 case 全件 `toolchain_missing`、Wave 3 は `ruby/lua/php/nim` が smoke/transpile green で parity pending とする。
