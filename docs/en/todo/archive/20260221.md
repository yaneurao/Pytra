<a href="../../../ja/todo/archive/20260221.md">
  <img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-2563EB?style=flat-square">
</a>

# TODO History (2026-02-21)

## 2026-02-21 Completed: CodeEmitter / Hooks migration batch (moved from `docs/ja/todo/index.md`)
...
- Added rules to `docs/en/spec/spec-east.md` for placement, indentation, multi-block concatenation, and precedence against docstring-comment conversion.
