<a href="../../../ja/todo/archive/20260222.md">
...
1. Marked `ID: P0-SH-01` and `ID: P0-SH-03` complete in `docs/ja/todo/index.md`.
2. Fixed root cause.
...
1. Marked completion of the `docs/en/todo/index.md` task: split `render_expr` Call branches by feature and migrate to `CodeEmitter` helpers.
...
1. Marked completion of the corresponding `docs/en/todo/index.md` reduction task.
2. Confirmed evidence.
...
1. Marked completion of the cleanup task in `docs/en/todo/index.md`.
...
1. Marked completion of the corresponding `docs/en/todo/index.md` task.
...
1. Marked completion of `Implement hook injection (EmitterHooks)` in `docs/en/todo/index.md`.
...
3. Added smoke/regression path (`tools/unittest/test_py2cs_smoke.py`).

## 2026-02-22 Completed: consumed P3/P4 batch in `docs/ja/todo/index.md`
...
## 2026-02-22 Completed: DOCS-SYNC-01 `todo/archive` translation-sync workflow

1. Marked `ID: DOCS-SYNC-01` complete in `docs/ja/todo/index.md`.
2. Added operational path for `docs/en/todo/archive/`.
- Added `tools/run/sync_todo_history_translation.py` for missing-file stub sync.
