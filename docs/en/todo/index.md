...
- [ ] [ID: P4-BACKEND-PARITY-REPRESENTATIVE-ROLLOUT-01] Fill the remaining unsupported support-matrix cells for the representative tier (`cpp/rs/cs`) as a live implementation rollout task (context: [p4-backend-parity-representative-rollout.md](../plans/p4-backend-parity-representative-rollout.md))
