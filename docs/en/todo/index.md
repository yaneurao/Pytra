...
Context: [docs/en/plans/p1-east23-lowering-decomposition.md](../plans/p1-east23-lowering-decomposition.md)
...
- Progress note: [ID: P1-EAST23-LOWERING-DECOMPOSITION-01-S2-03] The `nominal ADT ctor/projection/match metadata` cluster moved to `east2_to_east3_nominal_adt_meta.py`, and the main file now stays focused on decoration orchestration.
- Progress note: [ID: P1-EAST23-LOWERING-DECOMPOSITION-01-S3-01] The split source-contract was tightened, and representative regressions now live in `test_east2_to_east3_split_regressions.py` with shared nominal ADT fixtures.
