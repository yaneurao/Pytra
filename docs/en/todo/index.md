...
- Progress memo: [ID: P1-IR-CORE-DECOMPOSITION-01-S3-01] Promoted `_parse_primary` in `core_expr_primary.py` to a mixin, removed the primary wrapper from `core.py`, and normalized postfix source-contract boundaries to `def _make_bin`.
