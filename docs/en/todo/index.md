...
- Progress memo: `js` now has contract-driven representative transpile smoke locked; what remains is the `ts` smoke lane and the final `js/ts` coverage-baseline sync.
