<a href="../../ja/plans/archive/p0-selfhost-stabilization.md">
...
- 2026-02-22: Removed import-resolution table reinitialization from `CppEmitter.__init__`, fixing the route where selfhost C++ failed to resolve `math.*` due to base/derived member separation. Verified `failures=0` on multiple cases and `python3 tools/check/check_selfhost_direct_compile.py --cases sample/py/*.py`.
