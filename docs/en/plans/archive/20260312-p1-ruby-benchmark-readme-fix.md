<a href="../../../ja/plans/archive/20260312-p1-ruby-benchmark-readme-fix.md">
...
- `tools/check/runtime_parity_check.py` (use existing flow)
...
- 2026-03-01: Ran `python3 tools/gen/regenerate_samples.py --langs ruby --stems 01_mandelbrot --force` and confirmed fresh regeneration (`summary: total=1 regen=1 fail=0`).
- 2026-03-01: Confirmed `SUMMARY cases=1 pass=1 fail=0` with `python3 tools/check/runtime_parity_check.py --case-root sample --targets ruby 01_mandelbrot --ignore-unstable-stdout` (`S1-02`).
