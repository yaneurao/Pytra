<a href="../../../ja/plans/archive/20260313-p0-collections-deque-cpp-rotate-support.md">
...
- `PYTHONPATH=src python3 -m unittest discover -s tools/unittest/emit/cpp -p 'test_py2cpp_features.py' -k deque_rotate`
