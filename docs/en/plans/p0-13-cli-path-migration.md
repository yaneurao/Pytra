<a href="../../ja/plans/p0-13-cli-path-migration.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-DC2626?style=flat-square"></a>
...
- `tools/unittest/emit/cpp/test_py2cpp_codegen_issues.py:152`
