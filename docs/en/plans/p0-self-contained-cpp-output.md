<a href="../../ja/plans/p0-self-contained-cpp-output.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-DC2626?style=flat-square"></a>
...
| `tools/gen/gen_makefile_from_manifest.py` | Makefile の `-I` パスを `out/cpp/` 基準に変更 |
