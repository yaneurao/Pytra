<a href="../../ja/plans/p0-12-py2x-cpp-options-forwarding.md"><img alt="Read in Japanese" src="https://img.shields.io/badge/docs-日本語-DC2626?style=flat-square"></a>
...
- `tools/unittest/emit/cpp/test_py2cpp_features.py` — CLI subprocess テストを `toolchain/emit/cpp/cli.py` 直接呼び出しに変更
- `tools/unittest/emit/cpp/test_cpp_optimizer_cli.py` — 同様の修正
