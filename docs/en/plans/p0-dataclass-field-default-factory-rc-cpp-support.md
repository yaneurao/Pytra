...
- [ ] [ID: P0-DATACLASS-FIELD-DEFAULT-FACTORY-RC-CPP-01-S1-01] Lock the minimal-sample baseline and current C++ failure with focused regressions, TODO, and plan.
- [ ] [ID: P0-DATACLASS-FIELD-DEFAULT-FACTORY-RC-CPP-01-S2-01] Align `default_factory` with the correct ctor/member-init lowering in the representative C++ rc-field lane.
