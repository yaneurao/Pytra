<a href="../../ja/plans/p0-cpp-s18-token-dispatch-tagization.md">
...
- 2026-03-01: Confirmed non-regression with `PYTHONPATH=src python3 -m unittest discover -s test/unit -p 'test_py2cpp_codegen_issues.py' -v` (82 tests), `python3 tools/check/check_py2cpp_transpile.py` (`checked=134 ok=134 fail=0 skipped=6`), and `runtime_parity_check` (sample/18 cpp PASS).
