...
- [ ] [ID: P0-RAW-EAST3-NODE-SHAPE-VALIDATOR-01-S1-01] Lock `any_dict_items` / `18_mini_language_interpreter` and a synthetic auxiliary-map case into regression tests and the plan.
