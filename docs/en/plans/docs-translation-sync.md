<a href="../../ja/plans/docs-translation-sync.md">
...
Objective:
- Define a repeatable routine to synchronize `docs/ja/todo/archive/YYYYMMDD.md` to `docs/en/todo/archive/YYYYMMDD.md`.
...
- Differences between `docs/ja/` and `docs/en/` are easy to inspect.
- Date-file set parity between `docs/ja/todo/archive` and `docs/en/todo/archive` can be checked automatically.

Operational steps:
1. Run `python3 tools/sync_todo_history_translation.py` to create missing `docs/en/todo/archive/YYYYMMDD.md` mirror files.
...
4. Review granular diffs with `git diff -- docs/ja/todo/archive docs/en/todo/archive` and commit.
...
- 2026-02-22: Added `tools/sync_todo_history_translation.py` to automate date-file stub creation and index synchronization for `docs/en/todo/archive`.
