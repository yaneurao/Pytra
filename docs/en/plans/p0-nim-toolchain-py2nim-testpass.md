...
- `tools/unittest/test_py2nim_smoke.py` and Nim fixtures
...
- Added Nim path does not break existing major checks (at least `tools/check/check_py2cpp_transpile.py`).
...
- 2026-03-03: [ID: P0-NIM-TOOLCHAIN-PY2NIM-01-S3-01] Added `tools/unittest/test_py2nim_smoke.py`, reusing existing `test/fixtures/core|control|oop` to lock CLI/conversion path.
- 2026-03-03: [ID: P0-NIM-TOOLCHAIN-PY2NIM-01-S3-02] Added `tools/check/check_py2nim_transpile.py` and confirmed `checked=7 ok=7 fail=0`.
...
- 2026-03-03: [ID: P0-NIM-TOOLCHAIN-PY2NIM-01-S3-04] Ran `python3 tools/check/check_py2cpp_transpile.py` and confirmed no regression: `checked=140 ok=140 fail=0 skipped=6`.
...
- [x] [ID: P0-NIM-TOOLCHAIN-PY2NIM-01-S3-01] Add `tools/unittest/test_py2nim_smoke.py` and required fixtures, and lock minimal regression for Nim path.
- [x] [ID: P0-NIM-TOOLCHAIN-PY2NIM-01-S3-02] Add `tools/check/check_py2nim_transpile.py` to include batch transpile regression.
