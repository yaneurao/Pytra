...
- 2026-03-02: [ID: P3-PHP-BACKEND-01-S3-03] Updated doc paths. Added `py2php` and `test/transpile/php` / `sample/php` placement notes to `docs/{ja,en}/spec/spec-user.md`; added PHP run procedure and regression commands to `docs/{ja,en}/how-to-use.md`; reflected PHP link in sample-conversion code lists in `README.md` / `docs/ja/README.md`.
