...
- [ ] [ID: P0-RELATIVE-IMPORT-DIAGNOSTIC-REALIGN-01-S1-01] Lock the current stale diagnostics, desired contract, and representative failing surfaces into the plan and TODO.
