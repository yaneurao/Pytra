...
- 2026-03-03: Added `test/unit/test_pytra_layer_bootstrap.py` and locked public APIs (`pytra.frontends` and `pytra.ir` importability). Confirmed non-regression with `test_py2x_cli.py`, major transpile checks (`rs/js`), and version gate.
