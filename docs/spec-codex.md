...
- Check consistency of documents linked from `README.md` (`docs/how-to-use.md`, `docs/sample-code.md`, `docs/spec.md`, `docs/pytra-readme.md`) and their canonical Japanese sources (`docs-jp/how-to-use.md`, `docs-jp/spec/spec-sample-code.md`, `docs-jp/spec/index.md`, `docs-jp/plans/pytra-wip.md`), and update them together when needed.
