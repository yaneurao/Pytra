...
1. [x] `docs-jp/todo.md` の `ID: P0-SH-01` と `ID: P0-SH-03` を完了化した。
...
3. [x] import 仕様書へ重複配置除外ルールを明文化した。
   - [x] `docs-jp/spec-import.md` に `materials/refs/Yanesdk/docs/*/yanesdk.py` を重複コピーとして除外運用するルールを追記した。
...
3. [x] 文書ルールを同期した。
   - [x] `docs-jp/plans/archive/20260223-tg-docs-sync.md` に日次運用手順（同期・翻訳・check・diff確認）を追記した。
...
1. [x] `docs-jp/todo.md` の `ID: P0-SH-02` を完了した。
