...
class EastCoreSourceContractIfSemanticsTest(unittest.TestCase):
    ...
    def test_core_source_routes_if_tail_callback_dependencies_through_split_helper(self) -> None:
        ...
        self.assertIn("strip_inline_comment=_sh_strip_inline_comment", core_text)
        self.assertIn("raise_if_trailing_stmt_terminator=_sh_raise_if_trailing_stmt_terminator", core_text)
        self.assertIn("make_east_build_error=_make_east_build_error", core_text)
        self.assertIn("make_span=_sh_span", core_text)
        self.assertIn("collect_indented_block=_sh_collect_indented_block", core_text)
        self.assertIn("parse_expr_lowered=_sh_parse_expr_lowered", core_text)
        self.assertIn("parse_stmt_block=_sh_parse_stmt_block", core_text)
        self.assertIn("make_if_stmt=_sh_make_if_stmt", core_text)
        self.assertIn("block_end_span=_sh_block_end_span", core_text)
